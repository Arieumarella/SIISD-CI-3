              ...
              <div class="content-header bg-warning">
                  <div class="container-fluid">
                    <div class="row m-0 p-0 text-left">
                      <div class="col-sm-7">
                        <h4 class="m-0" id="titleBox">Form 5 : SHARING APBD</h4>
                    </div>

                    <div class="col-5 text-right">
                        <a href="<?= base_url(); ?>SharingAPBD" class="btn btn-default btn-sm" aksi="table" title="Kembali"><i class="fas fa-home"></i> Kembali</a>

                        <?php if ($this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'provinsi') { ?>

                            <a href="<?= base_url(); ?>SharingAPBD/editData/<?= $id; ?>" class="btn btn-primary btn-sm" aksi="ubah" title="Ubah data"><i class="far fa-edit"></i> Ubah</a>
                        ...
                        <?php if ($this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'provinsi') { ?>
                            <button onclick="deleteData('<?= $id; ?>')" class="btn btn-danger btn-sm" aksi="delete" title="Hapus data"><i class="far fa-trash-alt"></i> Hapus</button>
                        <?php } ?>
                    </div>
                </div>
            </div>
              ...
              <div class="row">
                <div class="card-body p-0 ">
                  ...
                  <div class="modal-body html-content" id="DivIdToPrint">
                    ...
                    <div class="row">            <div class="col-sm-6"> 
                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                            <div class="row p-0 m-0">
                                <label id="label_provid" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_provid" style="background-color:#e6e6e6;">Provinsi</label>
                                <div class="col-sm-6 pr-2 m-0 row">
                                    <div class="" id="isi_provid"><?= $dataHeader->provinsi; ?></div>
                                </div>
                            </div>
                        </div>
                    </div> 
                    <div class="col-sm-6"> 
                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                            <div class="row p-0 m-0">
                                <label id="label_kotakabid" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_kotakabid" style="background-color:#e6e6e6;">Kota/Kabupaten</label>
                                <div class="col-sm-6 pr-2 m-0 row">
                                    <div class="" id="isi_kotakabid"><?= $dataHeader->kemendagri; ?></div>
                                </div>
                            </div>
                        </div>
                    </div> 
                    <div class="col-sm-6"> 
                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                            <div class="row p-0 m-0">
                                <label id="label_noDpa" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_noDpa" style="background-color:#e6e6e6;">No. DPA</label>
                                <div class="col-sm-6 pr-2 m-0 row">
                                    <div class="" id="isi_noDpa"><?= $dataHeader->noDpa; ?></div>
                                </div>
                            </div>
                        </div>
                    </div> 
                    <div class="col-sm-6"> 
                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                            <div class="row p-0 m-0">
                                <label id="label_tanggal" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_tanggal" style="background-color:#e6e6e6;">Tanggal</label>
                                <div class="col-sm-6 pr-2 m-0 row">
                                    <div class="" id="isi_tanggal"><?= $dataHeader->tanggal; ?></div>
                                </div>
                            </div>
                        </div>
                    </div> 
                ...
                <div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
                    <div class="p-0 m-0" style="border:0px;">
                        <h5 class="card-title">Alokasi APBD (Rp)</h5>
                    </div>
                </div>
                <table class="table" border="1" style="font-size:12px;">
                    <thead>
                        <tr>
                            <th colspan="1" rowspan="2" class="text-center" style="width: 120px;">No</th>
                            <th colspan="1" rowspan="2" class="text-center">Kegiatan</th>
                            <th colspan="2" rowspan="1" class="text-center">Alokasi APBD (Rp)</th>
                        </tr>
                        <tr>
                            <th colspan="1" rowspan="1" class="text-center">APBD Non DAK</th>
                            <th colspan="1" rowspan="1" class="text-center">DAK</th>
                        </tr>
                    </thead>
                    <tbody id="boxTable">
                        <?php $no=1; ?>
  ...
  $(document).ready(function(){
    ...
    deleteData = function (id) {
        ...
        if (result.value) {
            ...
            $.ajax({
                url: base_url()+'SharingAPBD/delete',
                type: "post",
                dataType: 'json',
                data: {id},
                ...
                window.location = base_url()+'SharingAPBD';
