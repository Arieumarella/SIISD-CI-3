								...
								<?php foreach ($dataProv as $key => $val) { ?>
									...
									<tr style="background-color:#F7ECDE;">
										...
										<td style="border: thin solid #006666;" class="text-center">
											<button id="idButton<?= $val->kotakabid; ?>" class="btn btn-danger" onclick="showModalBa('<?= $val->kotakabid; ?>');" <?= $priv != 'admin' ? 'disabled' : ''; ?> <?= $val->pusat_verif !== '1' ? 'disabled' : ''; ?>>
										...
										<td style="border: thin solid #006666;" class="text-center">
											<input id='pemda<?= $no; ?>' type="checkbox" class="option-input checkbox" <?= $priv != 'pemda' ? 'disabled' : ''; ?> <?= $kondisi; ?> onclick="verifFunc('pemda<?= $no; ?>', '1', '<?= $val->kotakabid; ?>')" <?= $val->pemda_verif == '1' ? 'checked' : ''; ?>>
										</td>
										...
										<td style="border: thin solid #006666;" class="text-center">
											<input type="checkbox" id='balai<?= $no; ?>' class="option-input checkbox" <?= $priv != 'balai' ? 'disabled' : ''; ?> <?= $kondisi; ?> onclick="verifFunc('balai<?= $no; ?>', '3', '<?= $val->kotakabid; ?>')" <?= $val->balai_verif == '1' ? 'checked' : ''; ?>>
										</td>
										...
										<td style="border: thin solid #006666;" class="text-center">
											<input type="checkbox" id='pusat<?= $no; ?>' onclick="verifFunc('pusat<?= $no; ?>', '4', '<?= $val->kotakabid; ?>')" class="option-input checkbox" <?= $priv != 'admin' ? 'disabled' : ''; ?> <?= $kondisi; ?> <?= $val->pusat_verif == '1' ? 'checked' : ''; ?>>
