							...
							<tbody id="tbody_data">
								...
								<?php $no=1; foreach ($dataRekap as $key => $val) { ?>
									<tr>
										...
										<td class="text-left">    
											<a href="<?= base_url(); ?>DataTeknis/cheklistURKSimoni/<?= $val->kotakabid; ?>"><?= $val->kemendagri; ?></a>
										</td>
										<td class="text-center">
											<?php if ($val->id_lembar_ck_irigasi != null) { ?>
												<?php if ($val->ekstensi_lembar_ck_irigasi == 'pdf') { ?>
												...
												<?php }else{ ?>
													<a href="<?= base_url(); ?>DataTeknis/downloadFileById/<?= $val->id_lembar_ck_irigasi; ?>" class="btn btn-dark btn-icon"><i class="fa fa-file-archive fa-lg" aria-hidden="true"></i></a>
												<?php } ?>
												<br>
