					...
					<div class="card-body">
						...
						<table class="table table-bordered mt-4">
							<thead id="thead_data">
								...
								<tr id="boxThField" style="background-color:#18978F; color:#fff;">
									<th class="text-center" style="border: thin solid #006666;">Data Teknis</th>    
								...
								<?php $no=1; foreach ($dataRekap as $key => $val) { ?>
									<tr>
										...
										<td class="text-center">
											<?php if ($val->id_dataTeknis != null) { ?>

												<?php if ($val->ekstensi_dataTeknis == 'pdf') { ?>

													<button class="btn btn-danger btn-icon" onclick="showPdf('<?= $val->path_dataTeknis; ?>')"><i class="fa fa-file-pdf fa-lg" aria-hidden="true"></i></button>

												<?php }else{ ?>

													<a href="<?= base_url(); ?>DataTeknis/downloadFileById/<?= $val->id_dataTeknis; ?>" class="btn btn-dark btn-icon"><i class="fa fa-file-archive fa-lg" aria-hidden="true"></i></a>

												<?php } ?>
												<br>
												<?= $val->upload_time_dataTeknis; ?>

											<?php } ?>
										</td>

										<td class="text-center">
											<?php if ($val->id_rk != null) { ?>

												<?php if ($val->ekstensi_rk == 'pdf') { ?>

													<button class="btn btn-danger btn-icon" onclick="showPdf('<?= $val->path_rk; ?>')"><i class="fa fa-file-pdf fa-lg" aria-hidden="true"></i></button>

												<?php }else{ ?>

													<a href="<?= base_url(); ?>DataTeknis/downloadFileById/<?= $val->id_rk; ?>" class="btn btn-dark btn-icon"><i class="fa fa-file-archive fa-lg" aria-hidden="true"></i></a>
										...
										<td class="text-center">
											<?php if ($val->id_skema_jaringan != null) { ?>
												...
												<?php if ($val->ekstensi_skema_jaringan == 'pdf') { ?>
												...
												<?php }else{ ?>
													...
													<a href="<?= base_url(); ?>DataTeknis/downloadFileById/<?= $val->id_skema_jaringan; ?>" class="btn btn-dark btn-icon"><i class="fa fa-file-archive fa-lg" aria-hidden="true"></i></a>
										...
										<td class="text-center">
											<?php if ($val->id_skema_bangunan != null) { ?>
												...
												<?php if ($val->ekstensi_skema_bangunan == 'pdf') { ?>
												...
												<?php }else{ ?>
													...
													<a href="<?= base_url(); ?>DataTeknis/downloadFileById/<?= $val->id_skema_bangunan; ?>" class="btn btn-dark btn-icon"><i class="fa fa-file-archive fa-lg" aria-hidden="true"></i></a>
										...
										<td class="text-center">
											<?php if ($val->id_dpa != null) { ?>
												...
												<?php if ($val->ekstensi_dpa == 'pdf') { ?>

													<button class="btn btn-danger btn-icon" onclick="showPdf('<?= $val->path_dpa; ?>')"><i class="fa fa-file-pdf fa-lg" aria-hidden="true"></i></button>

												<?php }else{ ?>

													<a href="<?= base_url(); ?>DataTeknis/downloadFileById/<?= $val->id_dpa; ?>" class="btn btn-dark btn-icon"><i class="fa fa-file-archive fa-lg" aria-hidden="true"></i></a>
										...
										<td class="text-center">
											<?php if ($val->id_kebenaran_data != null) { ?>
												...
												<?php if ($val->ekstensi_kebenaran_data == 'pdf') { ?>
												...
												<?php }else{ ?>
													...
													<a href="<?= base_url(); ?>DataTeknis/downloadFileById/<?= $val->id_kebenaran_data; ?>" class="btn btn-dark btn-icon"><i class="fa fa-file-archive fa-lg" aria-hidden="true"></i></a>
										...
										<td class="text-center">
											<?php if ($val->id_pemenuhan_kriteria != null) { ?>
												...
												<?php if ($val->ekstensi_pemenuhan_kriteria == 'pdf') { ?>
												...
												<?php }else{ ?>
													...
													<a href="<?= base_url(); ?>DataTeknis/downloadFileById/<?= $val->id_pemenuhan_kriteria; ?>" class="btn btn-dark btn-icon"><i class="fa fa-file-archive fa-lg" aria-hidden="true"></i></a>
										...
										<td class="text-center">
											<?php if ($val->id_penyiapan_lahan != null) { ?>
												...
												<?php if ($val->ekstensi_penyiapan_lahan == 'pdf') { ?>
												...
												<?php }else{ ?>
													...
													<a href="<?= base_url(); ?>DataTeknis/downloadFileById/<?= $val->id_penyiapan_lahan; ?>" class="btn btn-dark btn-icon"><i class="fa fa-file-archive fa-lg" aria-hidden="true"></i></a>
