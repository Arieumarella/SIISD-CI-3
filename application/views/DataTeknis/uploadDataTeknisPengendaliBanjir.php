					...
					<div class="card-body align-self-center">
						...
						<form id="formDataTeknisIrigasi" class="form-horizontal" action="<?= base_url(); ?>DataTeknis/uplodaDataTeknisPengendaliBanjir" method="POST" enctype="multipart/form-data">
							...
							<script type="text/javascript">
								document.getElementById('lembar_ck_pb').addEventListener('change', function(event) {
							...
							<script type="text/javascript">
								document.getElementById('sid_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('ded_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('kak_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('skema_jaringan_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('skema_bangunan_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('bc_volume_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('rab_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('dokumentasi_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('dok_amdal_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('kesediaan_op_pb').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
