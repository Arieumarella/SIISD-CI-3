			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body align-self-center">
						<div class="row text-center col-12" style="margin-left: 0%;">
							<h3 class="font-weight-bolder">UPLOAD DOKUMEN DATA TEKNIS PENGENDALI BANJIR TA. <?= $this->session->userdata('thang'); ?></h3>
						</div>
						<form id="formDataTeknisIrigasi" class="form-horizontal" action="<?= base_url(); ?>DataTeknis/uplodaDataTeknisPengendaliBanjir" method="POST" enctype="multipart/form-data" >
							...
							<div class="form-group text-center row p-2 mt-4">
								<label for="lembar_ck_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">2. Lembar Checklist</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="sid_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">3. SID</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="ded_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">4. DED</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="kak_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">5. Kerangka Acuan Kerja</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="skema_jaringan_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">6. Skema Jaringan</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="skema_bangunan_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">7. Skema Bangunan</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="bc_volume_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">8. Backup Volume</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="rab_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">9. Rincian Anggaran Biaya</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="dokumentasi_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">10. Dokumentasi</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="dok_amdal_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">11. Dokumen Amdal</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="kesediaan_op_pb" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">12. Surat Kesediaan OP </label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
					...
					<div class="card-body">
						<p class="keterangan">*Untuk Dokumen Dengan Nomor Urut 1,2,6,7,11, dan 12 Harus Berekstensi PDF.</p>
						<p class="keterangan">*Untuk Dokumen Dengan Nomor Urut 3,4,5,8,9, dan 10 Harus Berekstensi ZIP/RAR.</p>
