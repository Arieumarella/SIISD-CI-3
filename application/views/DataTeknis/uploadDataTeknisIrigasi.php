				...
				<div class="card">
					<div class="card-body align-self-center">
						<div class="row text-center" style="margin-left: 20%;">
							<h3 class="font-weight-bolder">UPLOAD DOKUMEN DATA TEKNIS IRIGASI TA. <?= $this->session->userdata('thang'); ?></h3>
						</div>
						<form id="formDataTeknisIrigasi" class="form-horizontal" action="<?= base_url(); ?>DataTeknis/uplodaDataTeknisIrigasi" method="POST" enctype="multipart/form-data" >
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="rk" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">2. RK (Sudah ttd B/BWS dan Dinas Prov)</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
									<input type="file" class="custom-file-input file-sm" id="rk" name="rk" accept="application/pdf">
									<label class="custom-file-label" for="rk">Choose file</label>
								</div>
								<label class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-right">Status : <?= $dataForm->rk != null ? 'Sudah Upload' : 'Belum Upload'; ?></label>
							</div>


							<div class="form-group text-center row p-2 mt-2">
								<label for="sid" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">3. SID</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="ded" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">4. DED</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="kak" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">5. Kerangka Acuan Kerja</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="skema_jaringan" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">6. Skema Jaringan</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="skema_bangunan" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">7. Skema Bangunan</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="bc_volume" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">8. Backup Volume</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="rab" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">9. Rincian Anggaran Biaya</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="smk3" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">10. SMK3</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="dpa" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">11. DPA</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="dokumentasi" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">12. Dokumentasi</label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="kebenaran_data" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">13. Surat Pernyataan Kebenaran Data </label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="pemenuhan_kriteria" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">14. Surat Pemenuhan Kriteria Pembangunan </label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="penyiapan_lahan" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">15. Surat Pernyataan Penyediaan dan Penyiapan Lahan </label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
							...
							<div class="form-group text-center row p-2 mt-2">
								<label for="kesanggupan_op" class="col-lg-4 col-sm-12 col-form-label font-weight-bolder fontLabel text-left">16. Surat Pernyataan Kesanggupan OP Prasarana Jaringan Irigasi </label>
								<div class="col-lg-4 col-sm-12 text-left custom-file">
					...
					<div class="card-body">
						<p class="keterangan">*Untuk Dokumen Data Teknis Harus Berkstensi xlsx.</p>
						<p class="keterangan">*Untuk Dokumen Dengan Nomor Urut 2,6,7,11,13,14,15 dan 16 Harus Berekstensi PDF.</p>
						<p class="keterangan">*Untuk Dokumen Dengan Nomor Urut 23,4,5,8,9,10 dan 12 Harus Berekstensi ZIP/RAR.</p>
