					...
					<div class="card-body align-self-center">
						...
						<form id="formDataTeknisIrigasi" class="form-horizontal" action="<?= base_url(); ?>DataTeknis/uplodaDataTeknisIrigasi" method="POST" enctype="multipart/form-data">
							...
							<script type="text/javascript">
								document.getElementById('lembar_ck_irigasi').addEventListener('change', function(event) {
							...
							<script type="text/javascript">
								document.getElementById('sid').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('ded').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('kak').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('skema_jaringan').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('skema_bangunan').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('bc_volume').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('rab').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('smk3').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('dpa').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('kebenaran_data').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('pemenuhan_kriteria').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('penyiapan_lahan').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
							...
							<script type="text/javascript">
								document.getElementById('kesanggupan_op').addEventListener('change', function(event) {
									var fileName = event.target.files[0].name;
									var nextSibling = event.target.nextElementSibling;
									nextSibling.innerText = fileName;
								});
