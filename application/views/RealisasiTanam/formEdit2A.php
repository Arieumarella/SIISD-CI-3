        ...
        <div class="" data-select2-id="28"> <!-- content-wrapper -->
            ...
            <div class="row m-0" data-select2-id="27">
              ...
              <div class="col-lg-12 p-0" data-select2-id="26">
                <form role="form" action="<?= base_url(); ?>RealisasiTanam2A/SimpanDataEdit" method="POST" data-select2-id="25">
                  ...
                  <div class="content-header bg-warning">
                    <div class="container-fluid">
                      ...
                      <div class="col-sm-5 text-right">
                        <a href="<?= base_url(); ?>RealisasiTanam2A" class="btn btn-default btn-sm" title="Batal"><i class="fa fa-undo"></i> Kembali</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3"> 
                                    <div class="form-group">
                                        ...
                                        <input id="laPermen" name="laPermen" value="<?= str_replace('.', ',', $dataDi->lper); ?>" type="text" class="form-control text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); TotalRTanamPadi(); RealisasiTanamPalawija(); RealisasiTanamTebu(); RealisasiTanamLainnya();" readonly placeholder="Luas D.I. Sesuai Permen 14/2015 (Ha)" >
