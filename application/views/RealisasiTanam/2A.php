	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row m-0 p-0 text-left">
				<div class="col-sm-3">
					<h5 class="m-0 text-dark" id="titleBox">Data Form 2A : RTI D.I</h5>
				</div>
					...
					<div class="row">
						...
						<div class="row col-sm-12  col-lg-4 p-0 ml-1">
							...
							<?php if ($this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'pemda') { ?>
								...
								<a href="<?= base_url(); ?>RealisasiTanam2A/downloadTabel" class="btn btn-info mr-1"><i class="fas fa-file-excel"></i> Unduh</a>
							...
							<?php if ($this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'provinsi') { ?>
								...
								<a href="<?= base_url(); ?>RealisasiTanam2A/TambahData" class="btn btn-primary mr-1" aksi="add" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>

								<a href="<?= base_url(); ?>RealisasiTanam2A/formExcel" class="btn btn-success" aksi="add" title="Tambah Data"><i class="fas fa-file-excel"></i> Format Excel</a>
	...
	$(document).ready(function() {
		...
		getDataTabel = async function (page=null, providX=null, kotakabidX=null) {
			try{
				...
				ajaxUntukSemua(base_url()+'RealisasiTanam2A/getDataTable', {perhalaman, halamanSaatIni, search, provid, kotakabid}, function(data) {
		...
		function setTabelKonten(data) {
			...
			$.each(data, function(key, value) {
				...
				<td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}RealisasiTanam2A/getDetailData/${value.irigasiidX}">${cleanStr(value.nama)}</a></td>
...
$('#prov').change(function() {
	...
	ajaxUntukSemua(base_url()+'RealisasiTanam2A/getDataKabKota', {prov}, function(data) {
...
$('.select2_Irigasi').select2({
	...
	theme: 'default',
	ajax: {
		url: base_url() + "RealisasiTanam2A/getDi",
		dataType: 'json',
		type: 'post',
		delay: 250,
