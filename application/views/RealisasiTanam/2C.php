	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row m-0 p-0 text-left">
				<div class="col-sm-3">
					<h5 class="m-0 text-dark" id="titleBox">Data Form 2C : RTI D.I.A.T</h5>
				</div>
					...
					<div class="row">
						...
						<div class="row col-sm-12  col-lg-4 p-0 ml-1">
							...
							<?php if ($this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'provinsi') { ?>
								...
								<a href="<?= base_url(); ?>RealisasiTanam2C/TambahData" class="btn btn-primary mr-1" aksi="add" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>

								<a href="<?= base_url(); ?>RealisasiTanam2C/formExcel" class="btn btn-success" aksi="add" title="Tambah Data"><i class="fas fa-file-excel"></i> Format Excel</a>
	...
	$(document).ready(function() {
		...
		getDataTabel = async function (page=null, providX=null, kotakabidX=null) {
			try{
				...
				ajaxUntukSemua(base_url()+'RealisasiTanam2C/getDataTable', {perhalaman, halamanSaatIni, search, provid, kotakabid}, function(data) {
...
$('#prov').change(function() {
	...
	ajaxUntukSemua(base_url()+'RealisasiTanam2C/getDataKabKota', {prov}, function(data) {
...
$('.select2_Irigasi').select2({
	...
	theme: 'default',
	ajax: {
		url: base_url() + "RealisasiTanam2C/getDi",
		dataType: 'json',
		type: 'post',
		delay: 250,
