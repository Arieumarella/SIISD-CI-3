    ...
    <div class="" data-select2-id="28"> <!-- content-wrapper -->
        ...
        <div class="row m-0" data-select2-id="27">
          ...
          <div class="col-lg-12 p-0" data-select2-id="26">
            <form role="form" action="<?= base_url(); ?>RealisasiTanam2C/SimpanData" method="POST" data-select2-id="25">

              <div class="content-header bg-warning">
                <div class="container-fluid">
                  <div class="row m-0 p-0 text-left">
                    <div class="col-sm-7">
                      <h4 class="m-0">Form 2C : RTI D.I.A.T</h4>
                  </div>
...
<script>
  $(document).ready(function(){
    ...
    $('#irigasiid').on('change', function() {
        ...
        $.ajax({
            url: base_url()+'RealisasiTanam2C/getLapermen', 
            method: 'POST',
            data: {irigasiid:val},
            dataType: 'json',
    ...
    <?php if ($this->session->userdata('prive') == 'admin') { ?> 
        ...
        $('.select3').select2({
          ...
          theme: 'default',
          ajax: {
            url: base_url() + "RealisasiTanam2C/getDiTambahData",
            dataType: 'json',
            type: 'post',
            delay: 250,
