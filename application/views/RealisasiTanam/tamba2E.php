    ...
    <div class="" data-select2-id="28"> <!-- content-wrapper -->
        ...
        <div class="row m-0" data-select2-id="27">
          ...
          <div class="col-lg-12 p-0" data-select2-id="26">
            <form role="form" action="<?= base_url(); ?>RealisasiTanam2E/SimpanData" method="POST" data-select2-id="25">
              ...
              <div class="content-header bg-warning">
                <div class="container-fluid">
                  ...
                  <div class="col-sm-5 text-right">
                    <a href="<?= base_url(); ?>RealisasiTanam2E" class="btn btn-default btn-sm" title="Batal"><i class="fas fa-file"></i> Batal</a>
