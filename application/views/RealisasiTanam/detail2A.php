              ...
              <div class="content-header bg-warning">
                  <div class="container-fluid">
                    <div class="row m-0 p-0 text-left">
                      <div class="col-sm-7">
                        <h4 class="m-0" id="titleBox">Form 2A : RTI D.I</h4>
                    </div>
                    ...
                    <div class="col-5 text-right">
                        ...
                        <?php if ($this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'provinsi') { ?>
                            ...
                            <a href="<?= base_url(); ?>RealisasiTanam2A/editData/<?= $dataDi->irigasiidX; ?>" class="btn btn-primary btn-sm" aksi="ubah" title="Ubah data"><i class="far fa-edit"></i> Ubah</a>
  ...
  $(document).ready(function(){
    ...
    deleteData = function (id) {
        ...
        if (result.value) {
            ...
            $.ajax({
                url: base_url()+'RealisasiTanam2A/delete',
                type: "post",
                dataType: 'json',
                data: {id},
                ...
                window.location = base_url()+'RealisasiTanam2A';
