   ...
   <!-- <div class="wrapper"> -->
      ...
      <div class=""> <!-- content-wrapper -->
        <div class="" data-select2-id="28"> <!-- content-wrapper -->
            ...
            <div class="row m-0" data-select2-id="27">
              ...
              <div class="col-lg-12 p-0" data-select2-id="26">
                <form role="form" action="<?= base_url(); ?>RealisasiTanam2D/SimpanData" method="POST" data-select2-id="25">
        ...
        <section class="content" data-select2-id="24">
                ...
                <div class="row" data-select2-id="22">
                    ...
                    <div class="card-body p-0 " data-select2-id="21">
                        ...
                        <div class="modal-body" data-select2-id="20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input id="polatanamPadi3" class="form-check-input" idasli="in_polatanamPadi3" type="checkbox" value="V" valueasli="V" name="polatambakIkan3">
                                ...
                                <div class="col-sm-2"> 
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input id="polatanamPadi2Plw" class="form-check-input" name="polatambakIkan2Lain" idasli="in_polatanamPadi2Plw" type="checkbox" value="V" valueasli="V">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input id="polatanamPadiPlw2" class="form-check-input" idasli="in_polatanamPadiPlw2" name="polatambakIkanLain2" type="checkbox" value="V" valueasli="V">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input id="polatanamPadi2" class="form-check-input" name="polatambakIkan2" idasli="in_polatanamPadi2" type="checkbox" value="V" valueasli="V">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input id="polatanamPadiPlw" class="form-check-input" name="polatambakIkanLain" idasli="in_polatanamPadiPlw" type="checkbox" value="V" valueasli="V">
                                ...
                                <div class="col-sm-2"> 
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input id="polatanamPadi" class="form-check-input" idasli="in_polatanamPadi" name="polatambakIkan" type="checkbox" value="V" valueasli="V" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input id="reatamPadiMT1" name="ikanMT1" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT1 laPermen" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); TotalRTanamPadi();" placeholder="MT.1 (Ha)" required>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input id="reatamPadiMT2" name="ikanMT2" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT2" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); TotalRTanamPadi();" placeholder="MT.2 (Ha)" required>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input id="reatamPadiMT3" name="ikanMT3" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT3" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); TotalRTanamPadi();" placeholder="MT.3 (Ha)" required>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input id="reatamPadiTotalHa" value="" name="ikanTotalHa" type="text" class="form-control kududisabled" placeholder="Total (Ha)" readonly>
                                ...
                                <div class="col-sm-2"> 
                                    <div class="form-group">
                                        ...
                                        <input id="reatamPadiTotalHaIp" value="" name="ikanTotalHaIp" type="text" class="form-control kududisabled" placeholder="Total IP (%)" readonly>
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                   <div class="form-group">
                                    ...
                                    <input id="reatamPalawijaMT1" name="udangMT1" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT1 laPermen" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); RealisasiTanamPalawija();" placeholder="MT.1 (Ha)" required>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input id="reatamPalawijaMT2" name="udangMT2" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT2" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); RealisasiTanamPalawija();" placeholder="MT.2 (Ha)" required>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input id="reatamPalawijaMT3" name="udangMT3" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT3" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); RealisasiTanamPalawija();" placeholder="MT.3 (Ha)" required>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input id="reatamPalawijaTotalHa" value="" name="udangTotalHa" type="text" class="form-control kududisabled" placeholder="Total (Ha)" readonly>
                            ...
                            <div class="col-sm-2"> 
                                <div class="form-group">
                                    ...
                                    <input id="reatamPalawijaTotalHaIp" value="" name="udangTotalHaIp" type="text" class="form-control kududisabled" placeholder="Total IP (%)" readonly>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                               <div class="form-group">
                                ...
                                <input id="reatamTebuMT1" name="kepitingMT1" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT1 laPermen" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); RealisasiTanamTebu();" placeholder="MT.1 (Ha)" required>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input id="reatamTebuMT2" name="kepitingMT2" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT2" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); RealisasiTanamTebu();" placeholder="MT.2 (Ha)" required>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input id="reatamTebuMT3" name="kepitingMT3" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT3" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); RealisasiTanamTebu();" placeholder="MT.3 (Ha)" required>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input id="reatamTebuTotalHa" value="" name="kepitingTotalHa" type="text" class="form-control kududisabled" placeholder="Total (Ha)" readonly>
                        ...
                        <div class="col-sm-2"> 
                            <div class="form-group">
                                ...
                                <input id="reatamTebuTotalHaIp" value="" name="kepitingTotalHaIp" type="text" class="form-control kududisabled" placeholder="Total IP (%)" readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                           <div class="form-group">
                            ...
                            <input id="reatamLainnyaMT1" name="lainMT1" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT1 laPermen" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); RealisasiTanamLainnya();" required placeholder="MT.1 (Ha)">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <input id="reatamLainnyaMT2" name="lainMT2" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT2" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); RealisasiTanamLainnya();" required placeholder="MT.2 (Ha)">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <input id="reatamLainnyaMT3" name="lainMT3" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT3" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); RealisasiTanamLainnya();" required placeholder="MT.3 (Ha)">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <input id="reatamLainnyaTotalHa" value="" name="lainTotalHa" type="text" class="form-control kududisabled" placeholder="Total (Ha)" readonly>
                    ...
                    <div class="col-sm-2"> 
                        <div class="form-group">
                            ...
                            <input id="reatamLainnyaTotalHaIp" value="" name="lainTotalHaIp" type="text" class="form-control kududisabled" placeholder="Total IP (%)" readonly>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                   <div class="form-group">
                    ...
                    <input id="produktivitasPadiMT1" name="produktivitasIkanMT1" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT1 laPermen" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); produktivitasPadi();" placeholder="MT.1 (Ton/Ha)" required>
            ...
            <div class="col-sm-2">
               <div class="form-group">
                ...
                <input id="produktivitasPadiMT2" name="produktivitasIkanMT2" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT1 laPermen" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); produktivitasPadi();" placeholder="MT.2 (Ton/Ha)" required>
        ...
        <div class="col-sm-2">
           <div class="form-group">
            ...
            <input id="produktivitasPadiMT3" name="produktivitasIkanMT3" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT1 laPermen" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); produktivitasPadi();" placeholder="MT.3 (Ton/Ha)" required>
    ...
    <div class="col-sm-2">
       <div class="form-group">
        ...
        <input id="produktivitasRata2" name="produktivitasIkanRata2" value="" type="text" class="form-control text-right number reatamPadiTotalHa jmlMT1 laPermen" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); " readonly placeholder="Rata2 (Ton/Ha)">
...
<script>
  $(document).ready(function(){
    ...
    $('#irigasiid').on('change', function() {
        ...
        $.ajax({
            url: base_url()+'RealisasiTanam2D/getLapermen', 
            method: 'POST',
            data: {irigasiid:val},
            dataType: 'json',
    ...
    <?php if ($this->session->userdata('prive') == 'admin') { ?> 
        ...
        $('.select3').select2({
          ...
          theme: 'default',
          ajax: {
            url: base_url() + "RealisasiTanam2D/getDiTambahData",
            dataType: 'json',
            type: 'post',
            delay: 250,
