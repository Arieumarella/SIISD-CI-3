	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row m-0 p-0 text-left">
				<div class="col-sm-3">
					<h5 class="m-0 text-dark" id="titleBox">Data Form 3A : SDM OP</h5>
				</div>
					...
					<div class="row">
						...
						<div class="row col-sm-12  col-lg-4 p-0" style="margin-left: -50px;">
							...
							<?php if ($this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'provinsi') { ?>
								...
								<a href="<?= base_url(); ?>SdmOp3A/TambahData" class="btn btn-primary mr-1" aksi="add" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>
					...
					<table class="table table-bordered">
						...
						<thead id="thead_data">
							<tr id="boxThField0" style="background-color:#18978F; color:#fff;">
								...
								<th style="border: thin solid #006666;" colspan="1" rowspan="1">Jumlah Daerah Irigasi</th>
								<th style="border: thin solid #006666;" colspan="1" rowspan="1">Luas Daerah Irigasi</th>
								<th style="border: thin solid #006666;" colspan="1" rowspan="1">Alokasi APBD OP Irigasi</th>
							</tr>
