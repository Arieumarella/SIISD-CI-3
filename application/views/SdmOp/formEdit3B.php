          ...
          <div class="col-lg-12 p-0" >
                    ...
                    <div class="container-fluid">
                      <div class="row m-0 p-0 text-left">
                        ...
                        <div class="col-sm-5 text-right">
                            <a href="<?= base_url(); ?>SdmOp3B/getDetailData/<?= $id; ?>" class="btn btn-default btn-sm" title="Kembali"><i class="fa fa-undo"></i> Kembali</a>
            ...
            <section class="content" >
                        ...
                        <div class="card-body p-0 " >
                            ...
                            <div class="col-sm-12 col-lg-3" > 
                                <div class="form-group" >
                                    ...
                                    <input id="alokasiApbn" name="alokasiApbn" value="<?= str_replace('.', ',', $dataHeader->dak); ?>" type="text" class="form-control text-right number" oninput="this.value = this.value.replace(/[^0-9]/g, '');" disabled required placeholder="Alokasi APBD O&P Irigasi TA <?= $this->session->userdata('thang'); ?> (Rp)" required>
                                </div>
                            </div> 
                                    ...
                                    <tbody id="boxTempatList" >
                                        ...
                                        <tbody id="bosTempatisiPerkakas-0">
                                                        ...
                                                        <td colspan="15"><div class="row col-sm-12">
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="in_alamat-1" name="uptd[]" value="<?= $val->upt; ?>" type="text" class="form-control grupTempatF dampak_idTempat"  placeholder="Kantor UPTD/Pengamat" noklaster="" required>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="in_nama-1" name="nama[]" value="<?= $val->nm_kantor; ?>" type="text" class="form-control grupTempatF dampak_idTempat" noklaster="0"  placeholder="Nama Kantor" required>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="in_alamat-1" name="alamat[]" value="<?= $val->alamat; ?>" type="text" class="form-control grupTempatF dampak_idTempat"  placeholder="Alamat" noklaster="" required>
                                            ...
                                            <tr id="tr_aLabel_19 trHapus<?= $noKuning; ?>">
                                                ...
                                                <td class="col-sm-3" style="min-width:100px; max-width:10%; ">
                                                    <input id="in_jmlOrg" name="jmlOrg[]" value="<?= $val->jmlOrg; ?>" type="text" required class="form-control grupTempat angka  text-right" oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="Jumlah ">
                ...
                <div class="modal-footer justify-content-between">
                    <div class="row">
                        <a href="<?= base_url(); ?>SdmOp3B/<?= $id; ?>" class="btn btn-default btn-sm" title="Kembali"><i class="fa fa-undo"></i> Kembali</a>
