                            ...
                            <div class="card-body p-0 ">
                                ...
                                <div class="modal-body html-content" id="DivIdToPrint">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                <div class="row p-0 m-0">
                                                    ...
                                                    <div class="col-sm-6 pr-2 m-0 row">
                                                        <div class="" id="isi_irigasiid"><?= number_format($dataHeader->dak, 0, ',', '.'); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table" border="1" style="font-size:12px;">
                                        <thead>
                                            <tr>
                                                <th colspan="1" rowspan="3" class="text-center">NO</th>
                                                <th colspan="1" rowspan="3" class="text-center">ORGANISASI PERSONALIA O&amp;P</th>
                                                <th colspan="11" rowspan="1" class="text-center">KONDISI SAAT INI</th>
                                                <th colspan="1" rowspan="2" class="text-center">KEBUTUHAN*</th>
                                                <th colspan="1" rowspan="2" class="text-center">KEKURANGAN*</th>
                                                <th colspan="1" rowspan="3" class="text-center">KETERANGAN</th>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="1" rowspan="1" class="text-center">NON PNS/ HARIAN</th>
                                                <th colspan="1" rowspan="1" class="text-center">S1/D4</th>
                                        ...
                                        <tbody id="boxTable">
                                            ...
                                            <?php foreach ($dataBody as $key => $value) { ?>
                                                ...
                                                <?php $kondisiTempat = $value->alamat;
                                                $nm_kantor = $value->nm_kantor; ?>

                                                <!-- Putih -->
                                                <tr>
                                                    <td><?= $nomorDetail;  ?></td>
                                                    <td class=""><?= $value->nm_lable; ?></td>
