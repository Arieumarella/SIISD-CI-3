                ...
                <div class="container-fluid">
                  <div class="row m-0 p-0 text-left">
                    ...
                    <div class="col-sm-5 text-right">
                        <a href="<?= base_url(); ?>SdmOp3A" class="btn btn-default btn-sm" title="Kembali"><i class="fa fa-undo"></i> Kembali</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-lg-3" data-select2-id="33"> 
                                    <div class="form-group" data-select2-id="32">
                                        ...
                                        <input id="alokasiApbn" name="alokasiApbn" value="<?= @$dataApbd->dak; ?>" type="text" class="form-control text-right number" oninput="this.value = this.value.replace(/[^0-9]/g, '');" disabled  placeholder="Alokasi APBD O&P Irigasi TA <?= $this->session->userdata('thang'); ?> (Rp)" >
                                    </div>
                                </div> 
                                        ...
                                        <tbody id="boxTempatList">
                                            ...
                                            <tr id="tr_aLabel_13">
                                                ...
                                                <td class="col-sm-3" style="min-width:200px;">                        
                                                    <input id="in_labelid" name="nm_label[]" readonly value="Kepala UPTD" class="form-control grupTempat" >
                                                ...
                                                <tr id="tr_aLabel_14">
                                                    ...
                                                    <td class="col-sm-3" style="min-width:200px;">           
                                                        <input id="in_labelid" name="nm_label[]" readonly value="Staf UPTD/Pengamat" class="form-control grupTempat">
                                                        <div class="invalid-feedback" id="pesan_labelid"></div>
                                                    </td>
                                                    <td class="col-sm-3" style="min-width:100px; max-width:10%; ">
                                                        <input id="in_jmlOrg" name="jmlOrg[]" value="" type="text" class="form-control grupTempat angka  text-right" oninput="this.value = this.value.replace(/[^0-9]/g, '');"  placeholder="Jumlah (Orang)">
                                                    ...
                                                    <tr id="tr_aLabel_14">
                                                        ...
                                                        <td class="col-sm-3" style="min-width:200px;">           
                                                            <input id="in_labelid" name="nm_label[]" readonly value="Juru / Mantri Pengairan" class="form-control grupTempat">
                                                            <div class="invalid-feedback" id="pesan_labelid"></div>
                                                        </td>
                                                        <td class="col-sm-3" style="min-width:100px; max-width:10%; ">
                                                            <input id="in_jmlOrg" name="jmlOrg[]" value="" type="text" class="form-control grupTempat angka  text-right" oninput="this.value = this.value.replace(/[^0-9]/g, '');"  placeholder="Jumlah (Orang)">
                                                        ...
                                                        <tr id="tr_aLabel_14">
                                                            ...
                                                            <td class="col-sm-3" style="min-width:200px;">           
                                                                <input id="in_labelid" name="nm_label[]" readonly value="Petugas Operasi Bendung/Pompa" class="form-control grupTempat">
                                                                <div class="invalid-feedback" id="pesan_labelid"></div>
                                                            </td>
                                                            <td class="col-sm-3" style="min-width:100px; max-width:10%; ">
                                                                <input id="in_jmlOrg" name="jmlOrg[]" value="" type="text" class="form-control grupTempat angka  text-right" oninput="this.value = this.value.replace(/[^0-9]/g, '');"  placeholder="Jumlah (Orang)">
                                                            ...
                                                            <tr id="tr_aLabel_14">
                                                                ...
                                                                <td class="col-sm-3" style="min-width:200px;">           
                                                                    <input id="in_labelid" name="nm_label[]" readonly value="Pekerja / Pekarya Saluran" class="form-control grupTempat">
                                                                    <div class="invalid-feedback" id="pesan_labelid"></div>
                                                                </td>
                                                                <td class="col-sm-3" style="min-width:100px; max-width:10%; ">
                                                                    <input id="in_jmlOrg" name="jmlOrg[]" value="" type="text" class="form-control grupTempat angka  text-right" oninput="this.value = this.value.replace(/[^0-9]/g, '');"  placeholder="Jumlah (Orang)">
                                                                ...
                                                                <tr id="tr_aLabel_14">
                                                                    ...
                                                                    <td class="col-sm-3" style="min-width:200px;">           
                                                                        <input id="in_labelid" name="nm_label[]" readonly value="Petugas Pintu Air" class="form-control grupTempat">
                                                                        <div class="invalid-feedback" id="pesan_labelid"></div>
                                                                    </td>
                                                                    <td class="col-sm-3" style="min-width:100px; max-width:10%; ">
                                                                        <input id="in_jmlOrg" name="jmlOrg[]" value="" type="text" class="form-control grupTempat angka  text-right" oninput="this.value = this.value.replace(/[^0-9]/g, '');"  placeholder="Jumlah (Orang)">
