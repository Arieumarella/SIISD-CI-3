        ...
        <div class="" data-select2-id="28"> <!-- content-wrapper -->
            ...
            <div class="row m-0" data-select2-id="27">
              ...
              <div class="col-lg-12 p-0" data-select2-id="26">
                <form role="form" action="<?= base_url(); ?>IndexKinerja4C/SimpanData" method="POST" data-select2-id="25">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangutarPengukur1" name="buSumurA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                        ...
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangunanPengukurValue1" name="buSumurB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(1);" required placeholder="Nilai Kondisi (%)">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangutarPengukur2" name="buPompaA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                                <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                            </div>
                                        </div> 
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangunanPengukurValue2" name="buPompaB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(2);" required placeholder="Nilai Kondisi (%)">
                                                <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                            </div>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangutarPengukur3" name="buRumahPompaA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                                <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                            </div>
                                        </div> 
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangunanPengukurValue3" name="buRumahPompaB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(3);" required placeholder="Nilai Kondisi (%)">
                                                <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                            </div>
                                        </div> 
                                    </div>
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelimpah</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur14" value="" name="blinPelimpahA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue14" name="blinPelimpahB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(14);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Saluran Gendong</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur15" value="" name="blinSaluranGendongA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue15" name="blinSaluranGendongB" value="" type="text" class="form-control text-right  number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(15);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelepas Tekan</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur16" value="" name="blinPelepasTekanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue16" name="blinPelepasTekanB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(16);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bak Kontrol</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur17" value="" type="text" name="blinBakKontrolA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue17" name="blinBakKontrolB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(17);" required placeholder="Nilai Kondisi (%)">
    ...
    <div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur18" name="blinPerkuatanTebingA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue18" name="blinPerkuatanTebingB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(18);" required placeholder="Nilai Kondisi (%)">
   ...
   <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tampungan Air/Reservoir</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur19" value="" name="balengTampungA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue19" name="balengTampungB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(19);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jalan Inspeksi</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur20" value="" name="balengJalanInspeksiA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue20" name="balengJalanInspeksiB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(20);" placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jembatan</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur21" value="" name="balengJembatanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue21" name="balengJembatanB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(21);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kantor Pengamat</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur22" value="" name="balengKantorPengamatA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue22" name="balengKantorPengamatB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(22);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gudang</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur23" value="" name="balengGudangA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue23" name="balengGudangB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(23);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Jaga</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur24" value="" name="balengRumahJagaA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue24" name="balengRumahJagaB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(24);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sanggar Tani</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur25" value="" name="balengSanggarTaniA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue25" name="balengSanggarTaniB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(25);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pintu Air</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur26" value="" name="saranaPintuAirA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
            </div>            
        </div> 
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue26" name="saranaPintuAirB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(26);" placeholder="Nilai Kondisi (%)">
                <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
            </div>        
        </div> 
    </div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Control Valve</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur27" value="" name="saranaControlValveA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue27" name="saranaControlValveB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(27);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Alat Ukur</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur28" value="" name="saranaAlatUkurA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue28" name="saranaAlatUkurB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(28);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<script>
  $(document).ready(function(){
    ...
    $('#irigasiid').on('change', function() {
        ...
        $.ajax({
            url: base_url()+'IndexKinerja4C/getLapermen', 
            method: 'POST',
            data: {irigasiid:val},
            dataType: 'json',
