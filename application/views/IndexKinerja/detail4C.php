              ...
              <div class="content-header bg-warning">
                  <div class="container-fluid">
                    <div class="row m-0 p-0 text-left">
                      <div class="col-sm-7">
                        <h4 class="m-0" id="titleBox">Form 4C : DATA KONDISI D.I.A.T</h4>
                    </div>
                    ...
                    <div class="col-5 text-right">
                        ...
                        <?php if ($this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'provinsi') { ?>
                            ...
                            <a href="<?= base_url(); ?>IndexKinerja4C/editData/<?= $dataDi->irigasiidX; ?>" class="btn btn-primary btn-sm" aksi="ubah" title="Ubah data"><i class="far fa-edit"></i> Ubah</a>
        ...
        <section class="content">
            <div class="container-fluid">
              ...
              <div class="row">
                ...
                <div class="row">     <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sumur</h5><div class="row">        <div class="col-sm-6">
                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                        <div class="row p-0 m-0">
                            <label id="label_buSumurA" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_buSumurA" style="background-color:#e6e6e6;">B/RR/RS/RB</label>
                            <div class="col-sm-6 pr-2 m-0 row">
                                <div class="" id="isi_buSumurA"><?= str_replace('.', ',',$dataDi->buSumurA); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                        <div class="row p-0 m-0">
                            <label id="label_buSumurB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_buSumurB" style="background-color:#e6e6e6;">Nilai Kondisi (%)</label>
                            <div class="col-sm-6 pr-2 m-0 row">
                                <div class="" id="isi_buSumurB"><?= str_replace('.', ',',$dataDi->buSumurB); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pompa</h5><div class="row">        <div class="col-sm-6">
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
...
<div class="row">     <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gorong</h5><div class="row">        <div class="col-sm-6">
    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
        <div class="row p-0 m-0">
...
<div class="row">     <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelimpah</h5><div class="row">        <div class="col-sm-6">
    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
        <div class="row p-0 m-0">
...
<div class="row">     <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tampungan Air/Reservoir</h5><div class="row">        <div class="col-sm-6">
    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
        <div class="row p-0 m-0">
            <label id="label_balengTampungA" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_balengTampungA" style="background-color:#e6e6e6;">B/RR/RS/RB</label>
            <div class="col-sm-6 pr-2 m-0 row">
                <div class="" id="isi_balengTampungA"><?= str_replace('.', ',',$dataDi->balengTampungA); ?></div>
            </div>
        </div>
    </div>
</div>
<div class="col-sm-6">
    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
        <div class="row p-0 m-0">
            <label id="label_balengTampungB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_balengTampungB" style="background-color:#e6e6e6;">Nilai Kondisi (%)</label>
            <div class="col-sm-6 pr-2 m-0 row">
                <div class="" id="isi_balengTampungB"><?= str_replace('.', ',',$dataDi->balengTampungB); ?></div>
            </div>
        </div>
    </div>
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jalan Inspeksi</h5><div class="row">        <div class="col-sm-6">
    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
        <div class="row p-0 m-0">
...
<div class="col-sm-6">
    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
        <div class="row p-0 m-0">
            ...
            <div class="col-sm-6 pr-2 m-0 row">
                <div class="" id="isi_keterangan"><?= str_replace('.', ',',$dataDi->keterangan); ?></div>
            </div>
        </div>
    </div>
</div>
  ...
  $(document).ready(function(){
    ...
    deleteData = function (id) {
        ...
        if (result.value) {
            ...
            $.ajax({
                url: base_url()+'IndexKinerja4C/delete',
                type: "post",
                dataType: 'json',
                data: {id},
                ...
                window.location = base_url()+'IndexKinerja4C';
