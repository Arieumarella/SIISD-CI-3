              ...
              <div class="content-header bg-warning">
                  <div class="container-fluid">
                    <div class="row m-0 p-0 text-left">
                      <div class="col-sm-7">
                        <h4 class="m-0" id="titleBox">Format Excel 4E</h4>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card card-dark">
                                ...
                                <form class="form-horizontal" method="POST" action="<?= base_url(); ?>IndexKinerja4E/downloadExcel">
                                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card card-dark">
                                ...
                                <form class="form-horizontal" action="<?= base_url(); ?>IndexKinerja4E/prosesUploadExcel" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <?php if ($this->session->userdata('prive') == 'admin') { ?>
                                        <div class="form-group row">
...
<script>
  $(document).ready(function(){
     ...
     $('#prov').change(function() {
      ...
      $.ajax({
          url: base_url()+'IndexKinerja4E/getDataKabKota',
          type: 'POST',
          dataType: 'json',
          data: {prov:val},
