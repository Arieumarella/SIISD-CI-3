        ...
        <div class="" data-select2-id="28"> <!-- content-wrapper -->
            ...
            <div class="row m-0" data-select2-id="27">
              ...
              <div class="col-lg-12 p-0" data-select2-id="26">
                <form role="form" action="<?= base_url(); ?>IndexKinerja4E/SimpanData" method="POST" data-select2-id="25">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input id="bangutarPengukur1" name="buPompaA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                            ...
                                            <div class="col-sm-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input id="bangunanPengukurValue1" name="buPompaB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(1);" required placeholder="Nilai Kondisi (%)">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input id="bangutarPengukur2" name="buRumahPompaA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                                    <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                                </div>
                                            </div> 
                                            <div class="col-sm-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input id="bangunanPengukurValue2" name="buRumahPompaB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(2);" required placeholder="Nilai Kondisi (%)">
                                                    <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input id="bangutarPengukur3" name="buJembatanPengambilanA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                                    <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                                </div>
                                            </div> 
                                            <div class="col-sm-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input id="bangunanPengukurValue3" name="buJembatanPengambilanB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(3);" required placeholder="Nilai Kondisi (%)">
                                                    <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input id="bangutarPengukur4" name="buRumahA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                                    <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                                </div>
                                            </div> 
                                            <div class="col-sm-6"> 
                                                <div class="form-group">
                                                    ...
                                                    <input id="bangunanPengukurValue4" name="buRumahB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(4);" required placeholder="Nilai Kondisi (%)">
                                                    <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                                </div>
                                            </div> 
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="bangutarPengukur5" name="bppBagiA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                    <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                </div>
                            ...
                            <div class="col-sm-6"> 
                                <div class="form-group">
                                    ...
                                    <input id="bangunanPengukurValue5" name="bppBagiB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(5);" required placeholder="Nilai Kondisi (%)">
                                    <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                </div>
                    ...
                    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bagi Sadap**</h5><div class="row">
                        ...
                        <div class="col-sm-6"> 
                            ...
                            <div class="form-group">
                                ...
                                <input id="bangutarPengukur6" value="" type="text" name="bppBagiSadapA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                        ...
                        <div class="col-sm-6"> 
                            <div class="form-group">
                                ...
                                <input id="bangunanPengukurValue6" name="bppBagiSadapB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(6);" required placeholder="Nilai Kondisi (%)">
                ...
                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sadap**</h5><div class="row">
                    ...
                    <div class="col-sm-6"> 
                        ...
                        <div class="form-group">
                            ...
                            <input id="bangutarPengukur7" name="bppSadapA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                    ...
                    <div class="col-sm-6"> 
                        <div class="form-group">
                            ...
                            <input id="bangunanPengukurValue7" name="bppSadapB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(7);" required placeholder="Nilai Kondisi (%)">
            ...
            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bangun Pengukur</h5><div class="row">
                ...
                <div class="col-sm-6"> 
                    ...
                    <div class="form-group">
                        ...
                        <input id="bangutarPengukur8" name="bppBangunanPengukurA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                ...
                <div class="col-sm-6"> 
                    <div class="form-group">
                        ...
                        <input id="bangunanPengukurValue8" name="bppBangunanPengukurB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(8);" required placeholder="Nilai Kondisi (%)">
     ...
     <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gorong-gorong</h5><div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <input id="bangutarPengukur9" name="bPembawaGorongA" value="" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue9" name="bPembawaGorongB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(9);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sipon</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur10" value="" type="text" name="bPembawaSiponA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue10" name="bPembawaSiponB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(10);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Talang</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur11" value="" type="text" name="bPembawaTalangA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_bPembawaSiponA"></div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue11" name="bPembawaTalangB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(11);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_bPembawaSiponB"></div>
        </div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Terjunan</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur12" value="" type="text" name="bPembawaTerjunanA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_bPembawaSiponA"></div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue12" name="bPembawaTerjunanB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(12);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_bPembawaSiponB"></div>
        </div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Got Miring
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangutarPengukur13" value="" type="text" name="bPembawaGotMiringA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_bPembawaSiponA"></div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue13" name="bPembawaGotMiringB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(13);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_bPembawaSiponB"></div>
        </div>
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Krib</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur14" value="" name="blinKribA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue14" name="blinKribB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(14);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelimpah</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur15" value="" name="blinPelimpahA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue15" name="blinPelimpahB" value="" type="text" class="form-control text-right  number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(15);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Saluran Gendong</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur16" value="" name="blinSaluranGendongA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue16" name="blinSaluranGendongB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(16);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelepas Tekan</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur17" value="" name="blinPelepasTekanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_blinPengurasA"></div>
        </div>
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue17" name="blinPelepasTekanB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(17);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_blinPengurasB"></div>
        </div>
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bak Kontrol
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur18" value="" name="blinBakKontrolA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_blinPengurasA"></div>
        </div>
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue18" name="blinBakKontrolB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(18);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_blinPengurasB"></div>
        </div>
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tanggul
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur19" value="" name="blinTanggungA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_blinPengurasA"></div>
        </div>
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue19" name="blinTanggungB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(19);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_blinPengurasB"></div>
        </div>
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Perkuatan Tebing
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur20" value="" name="blinPerkuatanTebingA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_blinPengurasA"></div>
        </div>
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue20" name="blinPerkuatanTebingB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(20);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_blinPengurasB"></div>
        </div>
    </div> 
</div>
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jalan Inspeksi</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur21" value="" name="balengJalanInspeksiA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue21" name="balengJalanInspeksiB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(21);" placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jembatan</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur22" value="" name="balengJembatanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue22" name="balengJembatanB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(22);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kantor Pengamat</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur23" value="" name="balengKantorPengamatA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue23" name="balengKantorPengamatB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(23);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gudang</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur24" value="" name="balengGudangA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue24" name="balengGudangB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(24);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Jaga</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur25" value="" name="balengRumahJagaA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue25" name="balengRumahJagaB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(25);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sanggar Tani</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur26" value="" name="balengSanggarTaniA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue26" name="balengSanggarTaniB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(26);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tampungan Air/Reservoir</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur27" value="" name="balengTampunganA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue27" name="balengTampunganB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(27);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pintu Air</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur28" value="" name="saranaPintuAirA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
            </div>            
        </div> 
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue28" name="saranaPintuAirB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(28);" placeholder="Nilai Kondisi (%)">
                <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
            </div>        
        </div> 
    </div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Control Valve</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur29" value="" name="saranaControlValveA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue29" name="saranaControlValveB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(29);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Alat Ukur</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur30" value="" name="saranaAlatUkurA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue30" name="saranaAlatUkurB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(30);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
