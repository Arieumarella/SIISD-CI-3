        ...
        <div class="" data-select2-id="28"> <!-- content-wrapper -->
            ...
            <div class="row m-0" data-select2-id="27">
              ...
              <div class="col-lg-12 p-0" data-select2-id="26">
                <form role="form" action="<?= base_url(); ?>IndexKinerja4E/SimpanDataEdit" method="POST" data-select2-id="25">

                  <div class="content-header bg-warning">
                    <div class="container-fluid">
                      <div class="row m-0 p-0 text-left">
                        <div class="col-sm-7">
                            <h4 class="m-0">Form 4E : DATA KONDISI D.I.P</h4>
                        </div>

                        <div class="col-sm-5 text-right">
                            <a href="<?= base_url(); ?>IndexKinerja4E" class="btn btn-default btn-sm" title="Kembali"><i class="fa fa-undo"></i> Kembali</a>
            ...
            <section class="content" data-select2-id="24">
                    ...
                    <div class="row" data-select2-id="22">
                        ...
                        <div class="card-body p-0 " data-select2-id="21">                        <!-- form start -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pompa</h5>
                                    <div class="row">
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                <label for="bangutarPengukur1">B/RR/RS/RB</label>
                                                <input id="bangutarPengukur1" name="buPompaA" value="<?= str_replace('.', ',', $dataDi->buPompaA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                        ...
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangunanPengukurValue1" name="buPompaB" value="<?= str_replace('.', ',', $dataDi->buPompaB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(1);" required placeholder="Nilai Kondisi (%)">
                                ...
                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Pompa</h5>
                                    <div class="row">
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                <label for="bangutarPengukur2">B/RR/RS/RB</label>
                                                <input id="bangutarPengukur2" name="buRumahPompaA" value="<?= str_replace('.', ',', $dataDi->buRumahPompaA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                                <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                            </div>
                                        </div> 
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangunanPengukurValue2" name="buRumahPompaB" value="<?= str_replace('.', ',', $dataDi->buRumahPompaB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(2);" required placeholder="Nilai Kondisi (%)">
                                                <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                            </div>
                                        </div> 
                                    </div>
                                ...
                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jembatan Pengambilan</h5>
                                    <div class="row">
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                <label for="bangutarPengukur3">B/RR/RS/RB</label>
                                                <input id="bangutarPengukur3" name="buJembatanPengambilanA" value="<?= str_replace('.', ',', $dataDi->buJembatanPengambilanA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                                <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                            </div>
                                        </div> 
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangunanPengukurValue3" name="buJembatanPengambilanB" value="<?= str_replace('.', ',', $dataDi->buJembatanPengambilanB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(3);" required placeholder="Nilai Kondisi (%)">
                                                <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                            </div>
                                        </div> 
                                    </div>
                                ...
                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Genset & Panel Elektrikal</h5>
                                    <div class="row">
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                <label for="bangutarPengukur4">B/RR/RS/RB</label>
                                                <input id="bangutarPengukur4" name="buRumahA" value="<?= str_replace('.', ',', $dataDi->buRumahA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                                <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                            </div>
                                        </div> 
                                        <div class="col-sm-6"> 
                                            <div class="form-group">
                                                ...
                                                <input id="bangunanPengukurValue4" name="buRumahB" value="<?= str_replace('.', ',', $dataDi->buRumahB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(4);" required placeholder="Nilai Kondisi (%)">
                                                <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                            </div>
                                        </div> 
                                    </div>
                            ...
                            <div class="col-sm-12" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bangunan Pengatur dan Pengukur*</h5>
                ...
                <div class="row">
                   <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bagi**</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6"> 
                            ...
                            <div class="form-group">
                                ...
                                <input id="bangutarPengukur5" name="bppBagiA" value="<?= str_replace('.', ',', $dataDi->bppBagiA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                            </div>
                        ...
                        <div class="col-sm-6"> 
                            <div class="form-group">
                                ...
                                <input id="bangunanPengukurValue5" name="bppBagiB" value="<?= str_replace('.', ',', $dataDi->bppBagiB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(5);" required placeholder="Nilai Kondisi (%)">
                                <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                            </div>
                ...
                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bagi Sadap**</h5><div class="row">
                    ...
                    <div class="col-sm-6"> 
                        ...
                        <div class="form-group">
                            ...
                            <input id="bangutarPengukur6" value="<?= str_replace('.', ',', $dataDi->bppBagiSadapA);  ?>" type="text" name="bppBagiSadapA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                    ...
                    <div class="col-sm-6"> 
                        <div class="form-group">
                            ...
                            <input id="bangunanPengukurValue6" name="bppBagiSadapB" value="<?= str_replace('.', ',', $dataDi->bppBagiSadapB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(6);" required placeholder="Nilai Kondisi (%)">
            ...
            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sadap**</h5><div class="row">
                ...
                <div class="col-sm-6"> 
                    ...
                    <div class="form-group">
                        ...
                        <input id="bangutarPengukur7" name="bppSadapA" value="<?= str_replace('.', ',', $dataDi->bppSadapA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                ...
                <div class="col-sm-6"> 
                    <div class="form-group">
                        ...
                        <input id="bangunanPengukurValue7" name="bppSadapB" value="<?= str_replace('.', ',', $dataDi->bppSadapB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(7);" required placeholder="Nilai Kondisi (%)">
        ...
        <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bangun Pengukur</h5><div class="row">
            ...
            <div class="col-sm-6"> 
                ...
                <div class="form-group">
                    ...
                    <input id="bangutarPengukur8" name="bppBangunanPengukurA" value="<?= str_replace('.', ',', $dataDi->bppBangunanPengukurA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            ...
            <div class="col-sm-6"> 
                <div class="form-group">
                    ...
                    <input id="bangunanPengukurValue8" name="bppBangunanPengukurB" value="<?= str_replace('.', ',', $dataDi->bppBangunanPengukurB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(8);" required placeholder="Nilai Kondisi (%)">
 ...
 <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gorong-gorong</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur9" name="bPembawaGorongA" value="<?= str_replace('.', ',', $dataDi->bPembawaGorongA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue9" name="bPembawaGorongB" value="<?= str_replace('.', ',', $dataDi->bPembawaGorongB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(9);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sipon</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur10" value="<?= str_replace('.', ',', $dataDi->bPembawaSiponA);  ?>" type="text" name="bPembawaSiponA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue10" name="bPembawaSiponB" value="<?= str_replace('.', ',', $dataDi->bPembawaSiponB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(10);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Talang</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur11" value="<?= str_replace('.', ',', $dataDi->bPembawaTalangA);  ?>" type="text" name="bPembawaTalangA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_bPembawaSiponA"></div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue11" name="bPembawaTalangB" value="<?= str_replace('.', ',', $dataDi->bPembawaTalangB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(11);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_bPembawaSiponB"></div>
        </div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Terjunan</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur12" value="<?= str_replace('.', ',', $dataDi->bPembawaTerjunanA);  ?>" type="text" name="bPembawaTerjunanA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_bPembawaSiponA"></div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue12" name="bPembawaTerjunanB" value="<?= str_replace('.', ',', $dataDi->bPembawaTerjunanB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(12);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_bPembawaSiponB"></div>
        </div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Got Miring
</h5><div class="row">

    <div class="col-sm-6">
        <div class="form-group">
            <label for="bangutarPengukur13">B/RR/RS/RB</label>
            <input id="bangutarPengukur13" value="<?= str_replace('.', ',', $dataDi->bPembawaGotMiringA);  ?>" type="text" name="bPembawaGotMiringA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_bPembawaSiponA"></div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue13" name="bPembawaGotMiringB" value="<?= str_replace('.', ',', $dataDi->bPembawaGotMiringB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(13);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_bPembawaSiponB"></div>
        </div>
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Krib</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur14" value="<?= str_replace('.', ',', $dataDi->blinKribA);  ?>" name="blinKribA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue14" name="blinKribB" value="<?= str_replace('.', ',', $dataDi->blinKribB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(14);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelimpah</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur15" value="<?= str_replace('.', ',', $dataDi->blinPelimpahA);  ?>" name="blinPelimpahA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue15" name="blinPelimpahB" value="<?= str_replace('.', ',', $dataDi->blinPelimpahB);  ?>" type="text" class="form-control text-right  number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(15);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Saluran Gendong</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur16">B/RR/RS/RB</label>
            <input id="bangutarPengukur16" value="<?= str_replace('.', ',', $dataDi->blinSaluranGendongA);  ?>" name="blinSaluranGendongA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue16" name="blinSaluranGendongB" value="<?= str_replace('.', ',', $dataDi->blinSaluranGendongB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(16);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelepas Tekan</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur17">B/RR/RS/RB</label>
            <input id="bangutarPengukur17" value="<?= str_replace('.', ',', $dataDi->blinPelepasTekanA);  ?>" name="blinPelepasTekanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_blinPengurasA"></div>
        </div>
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue17" name="blinPelepasTekanB" value="<?= str_replace('.', ',', $dataDi->blinPelepasTekanB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(17);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_blinPengurasB"></div>
        </div>
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bak Kontrol
</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur18">B/RR/RS/RB</label>
            <input id="bangutarPengukur18" value="<?= str_replace('.', ',', $dataDi->blinBakKontrolA);  ?>" name="blinBakKontrolA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_blinPengurasA"></div>
        </div>
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue18" name="blinBakKontrolB" value="<?= str_replace('.', ',', $dataDi->blinBakKontrolB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(18);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_blinPengurasB"></div>
        </div>
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tanggul
</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur19">B/RR/RS/RB</label>
            <input id="bangutarPengukur19" value="<?= str_replace('.', ',', $dataDi->blinTanggungA);  ?>" name="blinTanggungA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_blinPengurasA"></div>
        </div>
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue19" name="blinTanggungB" value="<?= str_replace('.', ',', $dataDi->blinTanggungB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(19);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_blinPengurasB"></div>
        </div>
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Perkuatan Tebing
</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur20">B/RR/RS/RB</label>
            <input id="bangutarPengukur20" value="<?= str_replace('.', ',', $dataDi->blinPerkuatanTebingA);  ?>" name="blinPerkuatanTebingA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_blinPengurasA"></div>
        </div>
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue20" name="blinPerkuatanTebingB" value="<?= str_replace('.', ',', $dataDi->blinPerkuatanTebingB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(20);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_blinPengurasB"></div>
        </div>
    </div> 
</div>
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jalan Inspeksi</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur21" value="<?= str_replace('.', ',', $dataDi->balengJalanInspeksiA);  ?>" name="balengJalanInspeksiA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue21" name="balengJalanInspeksiB" value="<?= str_replace('.', ',', $dataDi->balengJalanInspeksiB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(21);" placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jembatan</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur22" value="<?= str_replace('.', ',', $dataDi->balengJembatanA);  ?>" name="balengJembatanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue22" name="balengJembatanB" value="<?= str_replace('.', ',', $dataDi->balengJembatanB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(22);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kantor Pengamat</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur23" value="<?= str_replace('.', ',', $dataDi->balengKantorPengamatA);  ?>" name="balengKantorPengamatA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue23" name="balengKantorPengamatB" value="<?= str_replace('.', ',', $dataDi->balengKantorPengamatB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(23);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gudang</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur24" value="<?= str_replace('.', ',', $dataDi->balengGudangA);  ?>" name="balengGudangA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue24" name="balengGudangB" value="<?= str_replace('.', ',', $dataDi->balengGudangB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(24);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Jaga</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur25">B/RR/RS/RB</label>
            <input id="bangutarPengukur25" value="<?= str_replace('.', ',', $dataDi->balengRumahJagaA);  ?>" name="balengRumahJagaA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangunanPengukurValue25">Nilai Kondisi (%)</label>
            <input id="bangunanPengukurValue25" name="balengRumahJagaB" value="<?= str_replace('.', ',', $dataDi->balengRumahJagaB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(25);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sanggar Tani</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur26">B/RR/RS/RB</label>
            <input id="bangutarPengukur26" value="<?= str_replace('.', ',', $dataDi->balengSanggarTaniA);  ?>" name="balengSanggarTaniA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangunanPengukurValue26">Nilai Kondisi (%)</label>
            <input id="bangunanPengukurValue26" name="balengSanggarTaniB" value="<?= str_replace('.', ',', $dataDi->balengSanggarTaniB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(26);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tampungan Air/Reservoir</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur27">B/RR/RS/RB</label>
            <input id="bangutarPengukur27" value="<?= str_replace('.', ',', $dataDi->balengTampunganA);  ?>" name="balengTampunganA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangunanPengukurValue27">Nilai Kondisi (%)</label>
            <input id="bangunanPengukurValue27" name="balengTampunganB" value="<?= str_replace('.', ',', $dataDi->balengTampunganB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(27);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="row">
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pintu Air</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                <label for="bangutarPengukur28">B/RR/RS/RB</label>
                <input id="bangutarPengukur28" value="<?= str_replace('.', ',', $dataDi->saranaPintuAirA);  ?>" name="saranaPintuAirA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
            </div>            
        </div> 
        <div class="col-sm-6"> 
            <div class="form-group">
                <label for="bangunanPengukurValue28">Nilai Kondisi (%)</label>
                <input id="bangunanPengukurValue28" name="saranaPintuAirB" value="<?= str_replace('.', ',', $dataDi->saranaPintuAirB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(28);" placeholder="Nilai Kondisi (%)">
                <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
            </div>        
        </div> 
    </div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Control Valve</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur29">B/RR/RS/RB</label>
            <input id="bangutarPengukur29" value="<?= str_replace('.', ',', $dataDi->saranaControlValveA);  ?>" name="saranaControlValveA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangunanPengukurValue29">Nilai Kondisi (%)</label>
            <input id="bangunanPengukurValue29" name="saranaControlValveB" value="<?= str_replace('.', ',', $dataDi->saranaControlValveB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(29);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Alat Ukur</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur30">B/RR/RS/RB</label>
            <input id="bangutarPengukur30" value="<?= str_replace('.', ',', $dataDi->saranaAlatUkurA);  ?>" name="saranaAlatUkurA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangunanPengukurValue30">Nilai Kondisi (%)</label>
            <input id="bangunanPengukurValue30" name="saranaAlatUkurB" value="<?= str_replace('.', ',', $dataDi->saranaAlatUkurB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(30);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
