			...
			try {
				...
				for (const [key, value] of Object.entries(data)) {
					try{
						...
						if (value.irigasiidX == 46995) {
							
							totalNilai = '46.6093'; 
							totalNilaiKondisi = 'RB';
						}

						if (value.irigasiidX == 46998) {
						...
						<td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}IndexKinerja4B/getDetailData/${value.irigasiidX}">${cleanStr(value.nama)}</a></td>
						...
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.bppPrimerA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bppPrimerB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.bppSekunderA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bppSekunderB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.bppTersierA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bppTersierB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.bppPembuangA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bppPembuangB)}</td>

						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.bppBendungA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bppBendungBx)}" class="number">${cleanStr(value.bppBendungB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.blinTanggulA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinTanggulBx)}" class="number">${cleanStr(value.blinTanggulB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.blinPolderA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.blinPolderB)}</td>
						...
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.balengGorongA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666; ${bgTabelKolom(value.balengGorongBx)}" class="number">${cleanStr(value.balengGorongB)}</td>

						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.balengDermagaA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666; ${bgTabelKolom(value.balengDermagaBx)}" class="number">${cleanStr(value.balengDermagaB)}</td>
						...
						<td id="laBaku_50581" style="border: thin solid #006666; ${bgTabelKolom(value.saranaAlatUkurB)}" class="number">${cleanStr(value.saranaAlatUkurB)}</td>
