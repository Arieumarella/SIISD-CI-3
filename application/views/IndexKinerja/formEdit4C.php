    ...
    <div class="" data-select2-id="28"> <!-- content-wrapper -->
        ...
        <div class="row m-0" data-select2-id="27">
          ...
          <div class="col-lg-12 p-0" data-select2-id="26">
            <form role="form" action="<?= base_url(); ?>IndexKinerja4C/SimpanDataEdit" method="POST" data-select2-id="25">

              <div class="content-header bg-warning">
                <div class="container-fluid">
                  <div class="row m-0 p-0 text-left">
                    <div class="col-sm-7">
                      <h4 class="m-0">Form 4C : DATA KONDISI D.I.A.T</h4>
                  </div>

                  <div class="col-sm-5 text-right">
                    <a href="<?= base_url(); ?>IndexKinerja4C" class="btn btn-default btn-sm" title="Kembali"><i class="fa fa-undo"></i> Kembali</a>
                ...
                <div class="card-body p-0 " data-select2-id="21">                        
                    <div class="modal-body" data-select2-id="20">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sumur</h5>
                                <div class="row">
                                    <div class="col-sm-6"> 
                                        <div class="form-group">
                                            <label for="bangutarPengukur1">B/RR/RS/RB</label>
                                            <input id="bangutarPengukur1" name="buSumurA" value="<?= str_replace('.', ',', $dataDi->buSumurA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                    ...
                                    <div class="col-sm-6"> 
                                        <div class="form-group">
                                            ...
                                            <input id="bangunanPengukurValue1" name="buSumurB" value="<?= str_replace('.', ',', $dataDi->buSumurB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(1);" required placeholder="Nilai Kondisi (%)">
                                ...
                                <div class="row">
                                    <div class="col-sm-6"> 
                                        <div class="form-group">
                                            ...
                                            <input id="bangutarPengukur2" name="buPompaA" value="<?= str_replace('.', ',', $dataDi->buPompaA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                            <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                        </div>
                                    </div> 
                                    <div class="col-sm-6"> 
                                        <div class="form-group">
                                            ...
                                            <input id="bangunanPengukurValue2" name="buPompaB" value="<?= str_replace('.', ',', $dataDi->buPompaB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(2);" required placeholder="Nilai Kondisi (%)">
                                            <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6"> 
                                        <div class="form-group">
                                            ...
                                            <input id="bangutarPengukur3" name="buRumahPompaA" value="<?= str_replace('.', ',', $dataDi->buRumahPompaA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                                            <div class="invalid-feedback" id="pesan_bppBagiA"></div>
                                        </div>
                                    </div> 
                                    <div class="col-sm-6"> 
                                        <div class="form-group">
                                            ...
                                            <input id="bangunanPengukurValue3" name="buRumahPompaB" value="<?= str_replace('.', ',', $dataDi->buRumahPompaB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(3);" required placeholder="Nilai Kondisi (%)">
                                            <div class="invalid-feedback" id="pesan_bppBagiB"></div>
                                        </div>
                                    </div> 
                                </div>
...
<div class="row">
   <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gorong</h5><div class="row">
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelimpah</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur14" value="<?= str_replace('.', ',', $dataDi->blinPelimpahA);  ?>" name="blinPelimpahA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue14" name="blinPelimpahB" value="<?= str_replace('.', ',', $dataDi->blinPelimpahB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(14);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Saluran Gendong</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur15" value="<?= str_replace('.', ',', $dataDi->blinSaluranGendongA);  ?>" name="blinSaluranGendongA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue15" name="blinSaluranGendongB" value="<?= str_replace('.', ',', $dataDi->blinSaluranGendongB);  ?>" type="text" class="form-control text-right  number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(15);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelepas Tekan</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur16" value="<?= str_replace('.', ',', $dataDi->blinPelepasTekanA);  ?>" name="blinPelepasTekanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue16" name="blinPelepasTekanB" value="<?= str_replace('.', ',', $dataDi->blinPelepasTekanB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(16);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bak Kontrol</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur17">B/RR/RS/RB</label>
            <input id="bangutarPengukur17" value="<?= str_replace('.', ',', $dataDi->blinBakKontrolA);  ?>" type="text" name="blinBakKontrolA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue17" name="blinBakKontrolB" value="<?= str_replace('.', ',', $dataDi->blinBakKontrolB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(17);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Perkuatan Tebing</h5>
    <div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                <label for="bangutarPengukur18">B/RR/RS/RB</label>
                <input id="bangutarPengukur18" name="blinPerkuatanTebingA" value="<?= str_replace('.', ',', $dataDi->blinPerkuatanTebingA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue18" name="blinPerkuatanTebingB" value="<?= str_replace('.', ',', $dataDi->blinPerkuatanTebingB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(18);" required placeholder="Nilai Kondisi (%)">
 ...
 <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tampungan Air/Reservoir</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur19" value="<?= str_replace('.', ',', $dataDi->balengTampungA);  ?>" name="balengTampungA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue19" name="balengTampungB" value="<?= str_replace('.', ',', $dataDi->balengTampungB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(19);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jalan Inspeksi</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur20" value="<?= str_replace('.', ',', $dataDi->balengJalanInspeksiA);  ?>" name="balengJalanInspeksiA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue20" name="balengJalanInspeksiB" value="<?= str_replace('.', ',', $dataDi->balengJalanInspeksiB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(20);" placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jembatan</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur21" value="<?= str_replace('.', ',', $dataDi->balengJembatanA);  ?>" name="balengJembatanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue21" name="balengJembatanB" value="<?= str_replace('.', ',', $dataDi->balengJembatanB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(21);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kantor Pengamat</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur22" value="<?= str_replace('.', ',', $dataDi->balengKantorPengamatA);  ?>" name="balengKantorPengamatA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue22" name="balengKantorPengamatB" value="<?= str_replace('.', ',', $dataDi->balengKantorPengamatB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(22);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gudang</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur23" value="<?= str_replace('.', ',', $dataDi->balengGudangA);  ?>" name="balengGudangA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue23" name="balengGudangB" value="<?= str_replace('.', ',', $dataDi->balengGudangB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(23);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Jaga</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur24" value="<?= str_replace('.', ',', $dataDi->balengRumahJagaA);  ?>" name="balengRumahJagaA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue24" name="balengRumahJagaB" value="<?= str_replace('.', ',', $dataDi->balengRumahJagaB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(24);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sanggar Tani</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur25" value="<?= str_replace('.', ',', $dataDi->balengSanggarTaniA);  ?>" name="balengSanggarTaniA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue25" name="balengSanggarTaniB" value="<?= str_replace('.', ',', $dataDi->balengSanggarTaniB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(25);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pintu Air</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur26" value="<?= str_replace('.', ',', $dataDi->saranaPintuAirA);  ?>" name="saranaPintuAirA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
            </div>            
        </div> 
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue26" name="saranaPintuAirB" value="<?= str_replace('.', ',', $dataDi->saranaPintuAirB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(26);" placeholder="Nilai Kondisi (%)">
                <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
            </div>        
        </div> 
    </div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Control Valve</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur27" value="<?= str_replace('.', ',', $dataDi->saranaControlValveA);  ?>" name="saranaControlValveA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue27" name="saranaControlValveB" value="<?= str_replace('.', ',', $dataDi->saranaControlValveB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(27);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Alat Ukur</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur28" value="<?= str_replace('.', ',', $dataDi->saranaAlatUkurA);  ?>" name="saranaAlatUkurA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue28" name="saranaAlatUkurB" value="<?= str_replace('.', ',', $dataDi->saranaAlatUkurB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(28);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-12">
    <div class="form-group">
        ...
        <textarea id="in_keterangan" name="keterangan" class="form-control" rows="3" placeholder="Keterangan"><?= $dataDi->keterangan; ?></textarea>
