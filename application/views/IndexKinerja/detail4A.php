              ...
              <div class="content-header bg-warning">
                  <div class="container-fluid">
                    <div class="row m-0 p-0 text-left">
                      <div class="col-sm-7">
                        <h4 class="m-0" id="titleBox">Form 4A : DATA KONDISI D.I</h4>
                    </div>
                    ...
                    <div class="col-5 text-right">
                        ...
                        <?php if ($this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'provinsi') { ?>
                            ...
                            <a href="<?= base_url(); ?>IndexKinerja4A/editData/<?= $dataDi->irigasiidX; ?>" class="btn btn-primary btn-sm" aksi="ubah" title="Ubah data"><i class="far fa-edit"></i> Ubah</a>
                  ...
                  <div class="modal-body html-content" id="DivIdToPrint">
                    ...
                    <div class="row">     
                     <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                        <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bendung</h5>
                        <div class="row">        
                            <div class="col-sm-6">
                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                    <div class="row p-0 m-0">
                                        <label id="label_buBendungA" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_buBendungA" style="background-color:#e6e6e6;">B/RR/RS/RB</label>
                                        <div class="col-sm-6 pr-2 m-0 row">
                                            <div class="" id="isi_buBendungA"><?= str_replace('.', ',', $dataDi->buBendungA); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                    <div class="row p-0 m-0">
                                        <label id="label_buBendungB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_buBendungB" style="background-color:#e6e6e6;">Nilai Kondisi (%)</label>
                                        <div class="col-sm-6 pr-2 m-0 row">
                                            <div class="" id="isi_buBendungB"><?= str_replace('.', ',', $dataDi->buBendungB); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                            ...
                            <div class="row">        
                                <div class="col-sm-6">
                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                        <div class="row p-0 m-0">
                                            <label id="label_buPengambilanBebasA" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_buPengambilanBebasA" style="background-color:#e6e6e6;">B/RR/RS/RB</label>
                                            <div class="col-sm-6 pr-2 m-0 row">
                                                <div class="" id="isi_buPengambilanBebasA"><?= str_replace('.', ',', $dataDi->buPengambilanBebasA); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                        <div class="row p-0 m-0">
                                            <label id="label_buPengambilanBebasB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_buPengambilanBebasB" style="background-color:#e6e6e6;">Nilai Kondisi (%)</label>
                                            <div class="col-sm-6 pr-2 m-0 row">
                                                <div class="" id="isi_buPengambilanBebasB"><?= str_replace('.', ',', $dataDi->buPengambilanBebasB); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                ...
                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                    <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Embung</h5>
                                    <div class="row">        
                                        <div class="col-sm-6">
                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                <div class="row p-0 m-0">
                                                    <label id="label_buEmbungA" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_buEmbungA" style="background-color:#e6e6e6;">B/RR/RS/RB</label>
                                                    <div class="col-sm-6 pr-2 m-0 row">
                                                        <div class="" id="isi_buEmbungA"><?= str_replace('.', ',', $dataDi->buEmbungA); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                <div class="row p-0 m-0">
                                                    <label id="label_buEmbungB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_buEmbungB" style="background-color:#e6e6e6;">Nilai Kondisi (%)</label>
                                                    <div class="col-sm-6 pr-2 m-0 row">
                                                        <div class="" id="isi_buEmbungB"><?= str_replace('.', ',', $dataDi->buEmbungB); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">     
                                        <div class="col-sm-12" style="border:thin solid #e6e6e6; padding-top:2px;">
                                            <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Saluran Primer</h5>
                                            <div class="row">        
                                                <div class="col-sm-6">
                                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                        <div class="row p-0 m-0">
                                            ...
                                            <div class="col-sm-12" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Saluran Sekunder</h5>
                                                <div class="row">        
                                                    <div class="col-sm-6">
                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                            <div class="row p-0 m-0">
                                                ...
                                                <div class="col-sm-12" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                    <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Saluran Tersier</h5>
                                                    <div class="row">        
                                                        <div class="col-sm-6">
                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                <div class="row p-0 m-0">
                                                    ...
                                                    <div class="col-sm-12" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                        <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Saluran Pembuang</h5>
                                                        <div class="row">        
                                                            <div class="col-sm-6">
                                                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                    <div class="row p-0 m-0">
                                                        ...
                                                        <div class="row">     
                                                         <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                            <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bagi**</h5>
                                                            <div class="row">        
                                                                <div class="col-sm-6">
                                                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                        <div class="row p-0 m-0">
                                                            ...
                                                            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bagi Sadap**</h5>
                                                                <div class="row">        
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                            <div class="row p-0 m-0">
                                                                ...
                                                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                    <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sadap**</h5>
                                                                    <div class="row">        
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                <div class="row p-0 m-0">
                                                                    ...
                                                                    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                        <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bangun Pengukur</h5>
                                                                        <div class="row">        
                                                                            <div class="col-sm-6">
                                                                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                    <div class="row p-0 m-0">
                                                                        ...
                                                                        <div class="row">     
                                                                         <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                            <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gorong-gorong</h5>
                                                                            <div class="row">        
                                                                                <div class="col-sm-6">
                                                                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                        <div class="row p-0 m-0">
                                                                            ...
                                                                            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sipon</h5>
                                                                                <div class="row">        
                                                                                    <div class="col-sm-6">
                                                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                            <div class="row p-0 m-0">
                                                                                ...
                                                                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                    <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Talang</h5>
                                                                                    <div class="row">        
                                                                                        <div class="col-sm-6">
                                                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                <div class="row p-0 m-0">
                                                                                    ...
                                                                                    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                        <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Terjunan</h5>
                                                                                        <div class="row">        
                                                                                            <div class="col-sm-6">
                                                                                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                    <div class="row p-0 m-0">
                                                                                        ...
                                                                                        <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                            <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Got Miring</h5>
                                                                                            <div class="row">        
                                                                                                <div class="col-sm-6">
                                                                                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                        <div class="row p-0 m-0">
                                                                                            ...
                                                                                            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Flum</h5>
                                                                                                <div class="row">        
                                                                                                    <div class="col-sm-6">
                                                                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                            <div class="row p-0 m-0">
                                                                                                                <label id="label_bPembawaFlumA" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_bPembawaFlumA" style="background-color:#e6e6e6;">B/RR/RS/RB</label>
                                                                                                                <div class="col-sm-6 pr-2 m-0 row">
                                                                                                                    <div class="" id="isi_bPembawaFlumA"><?= str_replace('.', ',', $dataDi->bPembawaFlumA); ?></div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div> 
                                                                                                    <div class="col-sm-6">
                                                                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                            <div class="row p-0 m-0">
                                                                                                                <label id="label_bPembawaFlumB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_bPembawaFlumB" style="background-color:#e6e6e6;">Nilai Kondisi (%)</label>
                                                                                                                <div class="col-sm-6 pr-2 m-0 row">
                                                                                                                    <div class="" id="isi_bPembawaFlumB"><?= str_replace('.', ',', $dataDi->bPembawaFlumB); ?></div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                    <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Terowongan</h5>
                                                                                                    <div class="row">        
                                                                                                        <div class="col-sm-6">
                                                                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                <div class="row p-0 m-0">
                                                                                                                    <label id="label_bPembawaTerawanganA" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_bPembawaTerawanganA" style="background-color:#e6e6e6;">B/RR/RS/RB</label>
                                                                                                                    <div class="col-sm-6 pr-2 m-0 row">
                                                                                                                        <div class="" id="isi_bPembawaTerawanganA"><?= str_replace('.', ',', $dataDi->bPembawaTerawanganA); ?></div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div> 
                                                                                                        <div class="col-sm-6">
                                                                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                <div class="row p-0 m-0">
                                                                                                                    <label id="label_bPembawaTerawanganB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_bPembawaTerawanganB" style="background-color:#e6e6e6;">Nilai Kondisi (%)</label>
                                                                                                                    <div class="col-sm-6 pr-2 m-0 row">
                                                                                                                        <div class="" id="isi_bPembawaTerawanganB"><?= str_replace('.', ',', $dataDi->bPembawaTerawanganB); ?></div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    ...
                                                                                                    <div class="row">     
                                                                                                     <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                        <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kantong Lumpur/Sedimen</h5>
                                                                                                        <div class="row">        
                                                                                                            <div class="col-sm-6">
                                                                                                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                    <div class="row p-0 m-0">
                                                                                                                        <label id="label_blinKantongA" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_blinKantongA" style="background-color:#e6e6e6;">B/RR/RS/RB</label>
                                                                                                                        <div class="col-sm-6 pr-2 m-0 row">
                                                                                                                            <div class="" id="isi_blinKantongA"><?= str_replace('.', ',', $dataDi->blinKantongA); ?></div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div> 
                                                                                                            <div class="col-sm-6">
                                                                                                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                    <div class="row p-0 m-0">
                                                                                                                        <label id="label_blinKantongB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_blinKantongB" style="background-color:#e6e6e6;">Nilai Kondisi (%)</label>
                                                                                                                        <div class="col-sm-6 pr-2 m-0 row">
                                                                                                                            <div class="" id="isi_blinKantongB"><?= str_replace('.', ',', $dataDi->blinKantongB); ?></div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                            <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelimpah</h5>
                                                                                                            <div class="row">        
                                                                                                                <div class="col-sm-6">
                                                                                                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                        <div class="row p-0 m-0">
                                                                                                            ...
                                                                                                            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Penguras</h5>
                                                                                                                <div class="row">        
                                                                                                                    <div class="col-sm-6">
                                                                                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                            <div class="row p-0 m-0">
                                                                                                                                <label id="label_blinPengurasA" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_blinPengurasA" style="background-color:#e6e6e6;">B/RR/RS/RB</label>
                                                                                                                                <div class="col-sm-6 pr-2 m-0 row">
                                                                                                                                    <div class="" id="isi_blinPengurasA"><?= str_replace('.', ',', $dataDi->blinPengurasA); ?></div>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div> 
                                                                                                                    <div class="col-sm-6">
                                                                                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                            <div class="row p-0 m-0">
                                                                                                                                <label id="label_blinPengurasB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_blinPengurasB" style="background-color:#e6e6e6;">Nilai Kondisi (%)</label>
                                                                                                                                <div class="col-sm-6 pr-2 m-0 row">
                                                                                                                                    <div class="" id="isi_blinPengurasB"><?= str_replace('.', ',', $dataDi->blinPengurasB); ?></div>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                ...
                                                                                                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                    <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Saluran Gendomg</h5>
                                                                                                                    <div class="row">        
                                                                                                                        <div class="col-sm-6">
                                                                                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                <div class="row p-0 m-0">
                                                                                                                    ...
                                                                                                                    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                        <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Krib</h5>
                                                                                                                        <div class="row">        
                                                                                                                            <div class="col-sm-6">
                                                                                                                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                    <div class="row p-0 m-0">
                                                                                                                        ...
                                                                                                                        <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                            <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Perkuatan Tebing</h5>
                                                                                                                            <div class="row">        
                                                                                                                                <div class="col-sm-6">
                                                                                                                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                        <div class="row p-0 m-0">
                                                                                                                            ...
                                                                                                                            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tanggul</h5>
                                                                                                                                <div class="row">        
                                                                                                                                    <div class="col-sm-6">
                                                                                                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                            <div class="row p-0 m-0">
                                                                                                                                ...
                                                                                                                                <div class="row">     
                                                                                                                                 <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                    <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jalan Inspeksi</h5>
                                                                                                                                    <div class="row">        
                                                                                                                                        <div class="col-sm-6">
                                                                                                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                <div class="row p-0 m-0">
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                        <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jembatan</h5>
                                                                                                                                        <div class="row">        
                                                                                                                                            <div class="col-sm-6">
                                                                                                                                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                    <div class="row p-0 m-0">
                                                                                                                                        ...
                                                                                                                                        <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                            <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kantor Pengamat</h5>
                                                                                                                                            <div class="row">        
                                                                                                                                                <div class="col-sm-6">
                                                                                                                                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                        <div class="row p-0 m-0">
                                                                                                                                            ...
                                                                                                                                            <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                                <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gudang</h5>
                                                                                                                                                <div class="row">        
                                                                                                                                                    <div class="col-sm-6">
                                                                                                                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                            <div class="row p-0 m-0">
                                                                                                                                                ...
                                                                                                                                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                                    <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Jaga</h5>
                                                                                                                                                    <div class="row">        
                                                                                                                                                        <div class="col-sm-6">
                                                                                                                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                                <div class="row p-0 m-0">
                                                                                                                                                    ...
                                                                                                                                                    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                                        <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Genset/Panel Elektrikal</h5>
                                                                                                                                                        <div class="row">        
                                                                                                                                                            <div class="col-sm-6">
                                                                                                                                                                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                                    <div class="row p-0 m-0">
                                                                                                                                                        ...
                                                                                                                                                        <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                                            <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sanggar Tani</h5>
                                                                                                                                                            <div class="row">        
                                                                                                                                                                <div class="col-sm-6">
                                                                                                                                                                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                                        <div class="row p-0 m-0">
                                                                                                                                                            ...
                                                                                                                                                            <div class="row">     
                                                                                                                                                             <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                                                <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pintu Air</h5>
                                                                                                                                                                <div class="row">        
                                                                                                                                                                    <div class="col-sm-6">
                                                                                                                                                                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                                            <div class="row p-0 m-0">
                                                                                                                                                                ...
                                                                                                                                                                <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;">
                                                                                                                                                                    <h5 style="border-bottom:1px solid #994d00; color:#994d00;">Alat Ukur</h5>
                                                                                                                                                                    <div class="row">        
                                                                                                                                                                        <div class="col-sm-6">
                                                                                                                                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                                                <div class="row p-0 m-0">
                                                                                                                                                                    ...
                                                                                                                                                                    <div class="row">     
                                                                                                                                                                        <div class="col-sm-4" style="border:thin solid #e6e6e6;"><div class="row">        <div class="col-sm-6">
                                                                                                                                                                            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                                                                                                                                                                                <div class="row p-0 m-0">
                                                                                                                                      ...
                                                                                                                                      $(document).ready(function(){
                                                                                                                                        ...
                                                                                                                                        deleteData = function (id) {
                                                                                                                                            ...
                                                                                                                                            if (result.value) {
                                                                                                                                                ...
                                                                                                                                                $.ajax({
                                                                                                                                                    url: base_url()+'IndexKinerja4A/delete',
                                                                                                                                                    type: "post",
                                                                                                                                                    dataType: 'json',
                                                                                                                                                    data: {id},
                                                                                                                                                    ...
                                                                                                                                                    window.location = base_url()+'IndexKinerja4A';
