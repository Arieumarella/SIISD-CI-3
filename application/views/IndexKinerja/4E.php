	...
	$(document).ready(function() {
		...
		function setTabelKonten(data) {
			...
			$.each(data, function(key, value) {
				...
				<td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}IndexKinerja4E/getDetailData/${value.id}">${value.nama}</a></td>
				...
				<td id="laBaku_50581" style="border: thin solid #006666;" class="">${value.buJembatanPengambilanA}</td>
				<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${value.buJembatanPengambilanB}</td>
				...
				<td id="laBaku_50581" style="border: thin solid #006666;" class="">${value.blinKribA}</td>
				<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${value.blinKribB}</td>
				...
				<td id="laBaku_50581" style="border: thin solid #006666;" class="">${value.balengTampunganA}</td>
				<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${value.balengTampunganB}</td>
