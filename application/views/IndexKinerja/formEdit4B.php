    ...
    <div class="" data-select2-id="28"> <!-- content-wrapper -->
        ...
        <div class="row m-0" data-select2-id="27">
          ...
          <div class="col-lg-12 p-0" data-select2-id="26">
            <form role="form" action="<?= base_url(); ?>IndexKinerja4B/SimpanDataEdit" method="POST" data-select2-id="25">
              ...
              <div class="content-header bg-warning">
                <div class="container-fluid">
                  ...
                  <div class="col-sm-5 text-right">
                    <a href="<?= base_url(); ?>IndexKinerja4B" class="btn btn-default btn-sm" title="Batal"><i class="fas fa-file"></i> Batal</a>
     ...
     <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bangunan Pintu Primer</h5><div class="row">
        ...
        <div class="col-sm-6"> 
            ...
            <div class="form-group">
                ...
                <input id="bangutarPengukur1" name="bppPrimerA" value="<?= str_replace('.', ',', $dataDi->bppPrimerA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue1" name="bppPrimerB" value="<?= str_replace('.', ',', $dataDi->bppPrimerB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(1);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bangunan Pintu Sekunder</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur2" value="<?= str_replace('.', ',', $dataDi->bppSekunderA);  ?>" type="text" name="bppSekunderA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue2" name="bppSekunderB" value="<?= str_replace('.', ',', $dataDi->bppSekunderB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(2);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bangunan Pintu Tersier</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur3" name="bppTersierA" value="<?= str_replace('.', ',', $dataDi->bppTersierA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue3" name="bppTersierB" value="<?= str_replace('.', ',', $dataDi->bppTersierB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(3);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bangunan Pintu Pembuang</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur4" name="bppPembuangA" value="<?= str_replace('.', ',', $dataDi->bppPembuangA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue4" name="bppPembuangB" value="<?= str_replace('.', ',', $dataDi->bppPembuangB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(4);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Bendung</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur5" name="bppBendungA" value="<?= str_replace('.', ',', $dataDi->bppBendungA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_bppBangunanPengukurA"></div>
        </div>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue5" name="bppBendungB" value="<?= str_replace('.', ',', $dataDi->bppBendungB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(5);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_bppBangunanPengukurB"></div>
        </div>
   ...
   <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tanggul</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur6" name="blinTanggulA" value="<?= str_replace('.', ',', $dataDi->blinTanggulA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue6" name="blinTanggulB" value="<?= str_replace('.', ',', $dataDi->blinTanggulB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(6);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Polder</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur7" value="<?= str_replace('.', ',', $dataDi->blinPolderA);  ?>" type="text" name="blinPolderA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue7" name="blinPolderB" value="<?= str_replace('.', ',', $dataDi->blinPolderB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(7);" required placeholder="Nilai Kondisi (%)">
   ...
   <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jalan Inspeksi</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur8" value="<?= str_replace('.', ',', $dataDi->balengJalanInspeksiA);  ?>" name="balengJalanInspeksiA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue8" name="balengJalanInspeksiB" value="<?= str_replace('.', ',', $dataDi->balengJalanInspeksiB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(8);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jembatan</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur9" value="<?= str_replace('.', ',', $dataDi->balengJembatanA);  ?>" name="balengJembatanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue9" name="balengJembatanB" value="<?= str_replace('.', ',', $dataDi->balengJembatanB);  ?>" type="text" class="form-control text-right  number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(9);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gorong-Gorong</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur10" value="<?= str_replace('.', ',', $dataDi->balengGorongA);  ?>" name="balengGorongA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue10" name="balengGorongB" value="<?= str_replace('.', ',', $dataDi->balengGorongB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(10);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Dermaga</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur11" value="<?= str_replace('.', ',', $dataDi->balengDermagaA);  ?>" type="text" name="balengDermagaA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue11" name="balengDermagaB" value="<?= str_replace('.', ',', $dataDi->balengDermagaB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(11);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kantor Pengamat</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur12" name="balengKantorPengamatA" value="<?= str_replace('.', ',', $dataDi->balengKantorPengamatA);  ?>" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue12" name="balengKantorPengamatB" value="<?= str_replace('.', ',', $dataDi->balengKantorPengamatB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(12);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gudang</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur13" value="<?= str_replace('.', ',', $dataDi->balengGudangA);  ?>" name="balengGudangA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue13" name="balengGudangB" value="<?= str_replace('.', ',', $dataDi->balengGudangB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(13);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Jaga</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur14" value="<?= str_replace('.', ',', $dataDi->balengRumahJagaA);  ?>" name="balengRumahJagaA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue14" name="balengRumahJagaB" value="<?= str_replace('.', ',', $dataDi->balengRumahJagaB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(14);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sanggar Tani</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur15" value="<?= str_replace('.', ',', $dataDi->balengSanggarTaniA);  ?>" name="balengSanggarTaniA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_blinTanggungA"></div>
        </div>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue15" name="balengSanggarTaniB" value="<?= str_replace('.', ',', $dataDi->balengSanggarTaniB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(15);" required placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_blinTanggungB"></div>
        </div>
 ...
 <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pintu Air</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur16" value="<?= str_replace('.', ',', $dataDi->saranaPintuAirA);  ?>" name="saranaPintuAirA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue16" name="saranaPintuAirB" value="<?= str_replace('.', ',', $dataDi->saranaPintuAirB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(16);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Alat Ukur</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur17" value="<?= str_replace('.', ',', $dataDi->saranaAlatUkurA);  ?>" name="saranaAlatUkurA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue17" name="saranaAlatUkurB" value="<?= str_replace('.', ',', $dataDi->saranaAlatUkurB);  ?>" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(17);" placeholder="Nilai Kondisi (%)">
