					...
					<div class="row">
						...
						<div class="row col-sm-12  col-lg-4 p-0 ml-1">
							...
							<?php if ($this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'pemda') { ?>
								...
								<!-- <a href="<?= base_url(); ?>IndexKinerja4D/downloadTabel" class="btn btn-info mr-1"><i class="fas fa-file-excel"></i> Unduh</a> -->
			...
			try {
				...
				for (const [key, value] of Object.entries(data)) {
					try{
						...
						let arrayRataRata = [
							value.buPengambilanAirTawarB,
							value.buPengambilanAirAsinB,
							value.buStasiunPompaB,
							value.bPintuPrimerB,
							value.bPintuSekunderB,
							value.bPintuTersierB,
							value.bPintuPembuangB,
							...
							value.balengRumahB,
							value.balengKolamTandoB,
							value.balengKolamPengendapB,
							value.balengKolamPencampurB,
							value.balengJettiB,
						...
						<td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}IndexKinerja4D/getDetailData/${value.irigasiidX}">${cleanStr(value.nama)}</a></td>
						...
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.buPengambilanAirTawarA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.buPengambilanAirTawarB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.buPengambilanAirAsinA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.buPengambilanAirAsinB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.buStasiunPompaA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.buStasiunPompaB)}</td>
						...
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.bPintuPrimerA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bPintuPrimerB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.bPintuSekunderA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bPintuSekunderB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.bPintuTersierA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bPintuTersierB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.bPintuPembuangA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bPintuPembuangB)}</td>
						...
						<td id="laBaku_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bPembawaTalangB)}" class="number">${cleanStr(value.blinTanggungB)}</td>
						...
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.balengRumahA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.balengRumahB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.balengKolamTandoA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.balengKolamTandoB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.balengKolamPengendapA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.balengKolamPengendapB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.balengKolamPencampurA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.balengKolamPencampurB)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="">${cleanStr(value.balengJettiA)}</td>
						<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.balengJettiB)}</td>
