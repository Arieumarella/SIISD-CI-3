	...
	$(document).ready(function() {
		...
		function setTabelKonten(data) {
			...
			$.each(data, function(key, value) {
				...
				<td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}IndexKinerja4D/getDetailData/${value.irigasiidX}">${value.nama}</a></td>
				...
				<td id="laBaku_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.blinTanggungB)}</td>
