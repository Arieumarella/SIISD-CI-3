                ...
                <div class="container-fluid">
                  <div class="row m-0 p-0 text-left">
                    ...
                    <div class="col-sm-5 text-right">
                        <a href="<?= base_url(); ?>IndexKinerja4D" class="btn btn-default btn-sm" title="Batal"><i class="fas fa-file"></i> Batal</a>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Talang</h5><div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="bangutarPengukur9" value="" type="text" name="bPembawaTalangA" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue9" name="bPembawaTalangB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(9);" required placeholder="Nilai Kondisi (%)">
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Tanggul</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur10" value="" name="blinTanggungA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue10" name="blinTanggungB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(10);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Perkuatan Tebing</h5><div class="row">
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur11" value="" name="blinPerkuatanTebingA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue11" name="blinPerkuatanTebingB" value="" type="text" class="form-control text-right  number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(11);" required placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pelimpah</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur12" value="" name="blinPelimpahA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
    ...
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue12" name="blinPelimpahB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(12);" required placeholder="Nilai Kondisi (%)">
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jalan Inspeksi</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur13" value="" name="balengJalanInspeksiA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
        ...
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue13" name="balengJalanInspeksiB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(13);" placeholder="Nilai Kondisi (%)">
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jembatan</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur14" value="" name="balengJembatanA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue14" name="balengJembatanB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(14);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kantor Pengamat</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur15" value="" name="balengKantorPengamatA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue15" name="balengKantorPengamatB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(15);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Gudang</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur16" value="" name="balengGudangA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue16" name="balengGudangB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(16);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Jaga</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur17" value="" name="balengRumahJagaA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue17" name="balengRumahJagaB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(17);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Sanggar Tani</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur18" value="" name="balengSanggarTaniA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue18" name="balengSanggarTaniB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(18);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Rumah Genset/Panel Elektrikal</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur19" value="" name="balengRumahA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue19" name="balengRumahB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(19);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kolam Tando</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur20" value="" name="balengKolamTandoA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue20" name="balengKolamTandoB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(20);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kolam Pengendap</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur21" value="" name="balengKolamPengendapA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue21" name="balengKolamPengendapB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(21);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Kolam Pencampur</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur22" value="" name="balengKolamPencampurA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue22" name="balengKolamPencampurB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(22);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Jetti</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangutarPengukur23" value="" name="balengJettiA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            ...
            <input id="bangunanPengukurValue23" name="balengJettiB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(23);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
    ...
    <div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Pintu Air</h5><div class="row">
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangutarPengukur24" value="" name="saranaPintuAirA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
                <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
            </div>            
        </div> 
        <div class="col-sm-6"> 
            <div class="form-group">
                ...
                <input id="bangunanPengukurValue24" name="saranaPintuAirB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(24);" placeholder="Nilai Kondisi (%)">
                <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
            </div>        
        </div> 
    </div>
...
<div class="col-sm-4" style="border:thin solid #e6e6e6; padding-top:2px;"><h5 style="border-bottom:1px solid #994d00; color:#994d00;">Alat Ukur</h5><div class="row">
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangutarPengukur24">B/RR/RS/RB</label>
            <input id="bangutarPengukur24" value="" name="saranaAlatUkurA" type="text" class="form-control kududisabled" placeholder="B/RR/RS/RB" readonly>
            <div class="invalid-feedback" id="pesan_saranaAlatUkurA"></div>
        </div>            
    </div> 
    <div class="col-sm-6"> 
        <div class="form-group">
            <label for="bangunanPengukurValue24">Nilai Kondisi (%)</label>
            <input id="bangunanPengukurValue24" name="saranaAlatUkurB" value="" type="text" class="form-control text-right number rataJaringan" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); hitungBangunanPengukur(24);" placeholder="Nilai Kondisi (%)">
            <div class="invalid-feedback" id="pesan_saranaAlatUkurB"></div>
        </div>        
    </div> 
</div>
