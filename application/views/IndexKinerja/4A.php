	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row m-0 p-0 text-left">
				<div class="col-sm-3">
					<h5 class="m-0 text-dark" id="titleBox">Data Form 4A : DATA KONDISI D.I</h5>
				</div>
					...
					<table class="table table-bordered">
						...
						<thead id="thead_data">
							<tr id="boxThField0" style="background-color:#18978F; color:#fff;">
								...
								<th style="border: thin solid #006666;" colspan="88" rowspan="1">Kondisi Fisik Jaringan Irigasi Permukaan</th>
							...
							<tr id="boxThField1" style="background-color:#18978F; color:#fff;">
								...
								<th style="border: thin solid #006666;" colspan="14" rowspan="1">Bangunan Pembawa*</th>
							...
							<tr id="boxThField2" style="background-color:#18978F; color:#fff;">
								...
								<th style="border: thin solid #006666;" colspan="2" rowspan="1">Pengambilan Bebas</th>
								<th style="border: thin solid #006666;" colspan="2" rowspan="1">Stasiun Pompa</th>
								<th style="border: thin solid #006666;" colspan="2" rowspan="1">Embung</th>
								...
								<th style="border: thin solid #006666;" colspan="2" rowspan="1">Flum</th>
								<th style="border: thin solid #006666;" colspan="2" rowspan="1">Terowongan</th>
								<th style="border: thin solid #006666;" colspan="2" rowspan="1">Kantong Lumpur/Sedimen</th>
								<th style="border: thin solid #006666;" colspan="2" rowspan="1">Pelimpah</th>
								<th style="border: thin solid #006666;" colspan="2" rowspan="1">Penguras</th>
								<th style="border: thin solid #006666;" colspan="2" rowspan="1">Saluran Gendomg</th>
							...
							<tr id="boxThNo" style="background-color:#18978F; color:#fff;">
								...
								<th style="border: thin solid #006666;">94</th>
								<th style="border: thin solid #006666;">95</th>
							</tr>
			...
			try {
				...
				for (const [key, value] of Object.entries(data)) {
					try{
						...
						if (value.buBendungA == null && value.embung1a != null) {
