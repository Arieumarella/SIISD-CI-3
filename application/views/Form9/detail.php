...
<body class="m-0 p-0" id="bodyUtama">
    <div class="">
              ...
              <div class="content-header bg-warning">
                  <div class="container-fluid">
                    <div class="row m-0 p-0 text-left">
                      <div class="col-sm-7">
                        <h4 class="m-0" id="titleBox">Form 9 : AREAL TERDAMPAK DAN IKSI</h4>
                    </div>

                    <div class="col-5 text-right">
                        <a href="<?= base_url(); ?>Form9" class="btn btn-default btn-sm" aksi="table" title="Kembali"><i class="fas fa-home"></i> Kembali</a>

                        <?php if ($this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'provinsi') { ?>

                            <a href="<?= base_url(); ?>Form9/editData/<?= $dataDi->irigasiidX; ?>" class="btn btn-primary btn-sm" aksi="ubah" title="Ubah data"><i class="far fa-edit"></i> Ubah</a>
        ...
        <section class="content">
              ...
              <div class="row">
                ...
                <div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
                    <div class="p-0 m-0" style="border:0px;">
                        <h5 class="card-title">Areal Terdampak Kondisi Jaringan Irigasi (Ha)</h5>
                    </div>
                </div>
                ...
                <div class="row">            <div class="col-sm-6"> 
                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                        <div class="row p-0 m-0">
                            <label id="label_areaTerdampakJarIrigasiB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_areaTerdampakJarIrigasiB" style="background-color:#e6e6e6;">Baik (Ha)</label>
                            <div class="col-sm-6 pr-2 m-0 row">
                                <div class="" id="isi_areaTerdampakJarIrigasiB"><?= str_replace('.', ',', $dataDi->areaTerdampakJarIrigasiB); ?></div>
                            </div>
                        </div>
                    </div>
                </div> 
                ...
                <div class="col-sm-6"> 
                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                        <div class="row p-0 m-0">
                            <label id="label_areaTerdampakJarIrigasiRR" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_areaTerdampakJarIrigasiRR" style="background-color:#e6e6e6;">Rusak Ringan (Ha)</label>
                            <div class="col-sm-6 pr-2 m-0 row">
                                <div class="" id="isi_areaTerdampakJarIrigasiRR"><?= str_replace('.', ',', $dataDi->areaTerdampakJarIrigasiRR); ?></div>
                            </div>
                        </div>
                    </div>
                </div> 
                ...
                <div class="col-sm-6"> 
                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                        <div class="row p-0 m-0">
                            <label id="label_areaTerdampakJarIrigasiRS" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_areaTerdampakJarIrigasiRS" style="background-color:#e6e6e6;">Rusak Sedang (Ha)</label>
                            <div class="col-sm-6 pr-2 m-0 row">
                                <div class="" id="isi_areaTerdampakJarIrigasiRS"><?= str_replace('.', ',', $dataDi->areaTerdampakJarIrigasiRS); ?></div>
                            </div>
                        </div>
                    </div>
                </div> 
                ...
                <div class="col-sm-6"> 
                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                        <div class="row p-0 m-0">
                            <label id="label_areaTerdampakJarIrigasiRB" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_areaTerdampakJarIrigasiRB" style="background-color:#e6e6e6;">Rusak Berat (Ha)</label>
                            <div class="col-sm-6 pr-2 m-0 row">
                                <div class="" id="isi_areaTerdampakJarIrigasiRB"><?= str_replace('.', ',', $dataDi->areaTerdampakJarIrigasiRB); ?></div>
                            </div>
                        </div>
                    </div>
                </div> 
                ...
                <div class="col-sm-6"> 
                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                        <div class="row p-0 m-0">
                            <label id="label_areaTerdampakJarIrigasiT" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_areaTerdampakJarIrigasiT" style="background-color:#e6e6e6;">Total (Ha)</label>
                            <div class="col-sm-6 pr-2 m-0 row">
                                <div class="" id="isi_areaTerdampakJarIrigasiT"><?= str_replace('.', ',', $dataDi->areaTerdampakJarIrigasiT); ?></div>
                            </div>
                        </div>
                    </div>
                </div> 
            ...
            <div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
                <div class="p-0 m-0" style="border:0px;">
                    <h5 class="card-title">Indeks Kondisi Sistem Irigasi (%)</h5>
                </div>
            </div>
            ...
            <div class="row">            <div class="col-sm-6"> 
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
                        <label id="label_iKSIPrasaranaFisik" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_iKSIPrasaranaFisik" style="background-color:#e6e6e6;">Prasarana Fisik (Maks 45%)</label>
                        <div class="col-sm-6 pr-2 m-0 row">
                            <div class="" id="isi_iKSIPrasaranaFisik"><?= str_replace('.', ',', $dataDi->iKSIPrasaranaFisik); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-sm-6"> 
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
                        <label id="label_iKSIProduktivitas" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_iKSIProduktivitas" style="background-color:#e6e6e6;">Produktivitas (Maks 15%)</label>
                        <div class="col-sm-6 pr-2 m-0 row">
                            <div class="" id="isi_iKSIProduktivitas"><?= str_replace('.', ',', $dataDi->iKSIProduktivitas); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-sm-6"> 
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
                        <label id="label_iKSISaranaPenujang" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_iKSISaranaPenujang" style="background-color:#e6e6e6;">Sarana Penujang (Maks 10%)</label>
                        <div class="col-sm-6 pr-2 m-0 row">
                            <div class="" id="isi_iKSISaranaPenujang"><?= str_replace('.', ',', $dataDi->iKSISaranaPenujang); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-sm-6"> 
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
                        <label id="label_iKSIOrgPersonalia" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_iKSIOrgPersonalia" style="background-color:#e6e6e6;">Organisasi Personalia (Maks 15%)</label>
                        <div class="col-sm-6 pr-2 m-0 row">
                            <div class="" id="isi_iKSIOrgPersonalia"><?= str_replace('.', ',', $dataDi->iKSIOrgPersonalia); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-sm-6"> 
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
                        <label id="label_iKSIDokumentasi" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_iKSIDokumentasi" style="background-color:#e6e6e6;">Dokumentasi (Maks 5%)</label>
                        <div class="col-sm-6 pr-2 m-0 row">
                            <div class="" id="isi_iKSIDokumentasi"><?= str_replace('.', ',', $dataDi->iKSIDokumentasi); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-sm-6"> 
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
                        <label id="label_iKSIPGI" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_iKSIPGI" style="background-color:#e6e6e6;">P3A/GP3A/IP3A (Maks 10%)</label>
                        <div class="col-sm-6 pr-2 m-0 row">
                            <div class="" id="isi_iKSIPGI"><?= str_replace('.', ',', $dataDi->iKSIPGI); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
            <div class="col-sm-6"> 
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
                        <label id="label_iKSIJumlah" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_iKSIJumlah" style="background-color:#e6e6e6;">Jumlah (Maks 100%)</label>
                        <div class="col-sm-6 pr-2 m-0 row">
                            <div class="" id="isi_iKSIJumlah"><?= str_replace('.', ',', $dataDi->iKSIJumlah); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
    ...
    deleteData = function (id) {
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                window.location = base_url()+'Form9';
