									...
									<?php if ($dataRekap != null) { ?>
										...
										foreach ($dataRekap as $key => $val) { ?>
											...
											<tr>
												...
												<td class="text-center">
													<textarea class="form-control" rows="3" name="catat_provinsi[<?= $val->id; ?>]" <?= ($is_prive != 'provinsi') ? 'readonly' : ''; ?>><?= $val->catat_provinsi; ?></textarea>
												</td>
												<td class="text-center">
												...
												<td class="text-center">
													<textarea class="form-control" rows="3" name="catat_balai[<?= $val->id; ?>]" <?= ($prive != 'balai') ? 'readonly' : ''; ?>><?= $val->catat_balai; ?></textarea>
												</td>
												<td class="text-center">
												...
												<td class="text-center">
													<textarea class="form-control" rows="3" name="catat_sda[<?= $val->id; ?>]" <?= ($is_prive != 'sda') ? 'readonly' : ''; ?>><?= $val->catat_sda; ?></textarea>
												</td>
												<td class="text-center">
												...
												<td class="text-center">
													<textarea class="form-control" rows="3" name="catat_pfid[<?= $val->id; ?>]" <?= ($prive != 'admin') ? 'readonly' : ''; ?>><?= $val->catat_pusat; ?></textarea>
												</td>
											</tr>
