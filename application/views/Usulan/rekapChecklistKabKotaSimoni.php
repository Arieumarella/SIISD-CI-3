        ...
        <div class="row ">
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-left" style="background-color:rgba(0, 255, 0, 0);">
                    <li class="breadcrumb-item"><a href="<?= base_url(); ?>Usulan/rekapProv">Rekapitulasi Nasional</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <h4 class="mt-4"> REKAPITULASI PENILAIAN USULAN RENCANA KEGIATAN DAK BIDANG IRIGASI TA. <?= $this->session->userdata('thang'); ?></h4>
                        ...
                        <table class="tableX table-bordered mt-3">
                            ...
                            <thead id="thead_data">
                                ...
                                <tr id="boxThField1" style="background-color:#18978F; color:#fff;">
                                    <th style="border: thin solid #006666; width: 8%" rowspan="2">No</th>
                                    <th style="border: thin solid #006666; width: 20%;" rowspan="2">Kab/Kota</th>
