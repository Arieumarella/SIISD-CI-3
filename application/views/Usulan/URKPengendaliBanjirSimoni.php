                ...
                <form method="POST" action="<?= base_url(); ?>Usulan/tambahDataKomponen">
                    <div class="form-group">
                        ...
                        <select class="form-control select3" name="komponen" id="komponen" required>
                            ...
                            <?php } ?> -->
                            <option value="34">Bangunan perlindungan dan penguatan tebing sungai</option>
                            <option value="35">Bangunan Tanggul Sungai</option>
                            <option value="36">Kolam Retensi</option>
                        </select>
                    </div>
                    <div class="form-group">
