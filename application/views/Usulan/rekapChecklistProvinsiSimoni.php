            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <h4 class="mt-4 mb-2"> REKAPITULASI PENILAIAN USULAN RENCANA KEGIATAN DAK BIDANG IRIGASI TA. <?= $this->session->userdata('thang'); ?></h4>
                        <table class="tablex table-bordered mt-3">
                            <thead id="thead_data">

                                <tr id="boxThField1" style="background-color:#18978F; color:#fff;">
                                    <th style="border: thin solid #006666; width: 5%" rowspan="2">No</th>
                                    <th style="border: thin solid #006666; width: 20%;" rowspan="2">PROVINSI</th>
                                    <th style="border: thin solid #006666; width: 15%;" rowspan="2">TOTAL PEMDA</th>
                                    <th style="border: thin solid #006666; width: 17%;" rowspan="2">TOTAL <br> USULAN RENCANA KEGIATAN</th>
                                    <th style="border: thin solid #006666;" colspan="4">CHEKLIST KEGIATAN</th>
                                </tr>
                                <tr id="boxThField1" style="background-color:#18978F; color:#fff;">
                                    <th style="border: thin solid #006666; width: 15%;">BALAI</th>
                                    <th style="border: thin solid #006666; width: 15%;">SDA</th>
                                    <th style="border: thin solid #006666; width: 15%;">PFID</th>
                                </tr>
                            </thead>
                            <tbody id="tbody_data">
                                <?php
                                ...
                                <?php foreach ($dataRekap as $key => $val) { ?>
                                    <tr style="background-color:#F7ECDE;">
                                        ...
                                        <td style="border: thin solid #006666; text-align: left;">
                                            <a href="<?= base_url(); ?>Usulan/rekapKabKota/<?= $val->provid; ?>"><?= $val->provinsi; ?></a>
                                        </td>
                                        <td style="border: thin solid #006666;" class="number"><?= $val->jml_pemda; ?></td>
