	...
	$(document).ready(function() {
		...
		getDataTabel = async function(page = null, providX = null, kotakabidX = null) {
			try {
				...
				ajaxUntukSemua(base_url() + 'FormTeknis1E/getDataTable', {
					perhalaman,
					halamanSaatIni,
					search,
					provid,
		...
		function setTabelKonten(data) {
			...
			$.each(data, function(key, value) {
				...
				<td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}FormTeknis1E/getDetailData/${value.irigasiidX}">${cleanStr(value.nama)}</a></td>
		...
		$('#prov').change(function() {
			...
			ajaxUntukSemua(base_url() + 'FormTeknis1E/getDataKabKota', {
				prov
			}, function(data) {
