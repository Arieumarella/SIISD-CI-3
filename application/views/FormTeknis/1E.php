	...
	$(document).ready(function() {
		...
		function setTabelKonten(data) {
			...
			$.each(data, function(key, value) {
				...
				<td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}FormTeknis1E/getDetailData/${value.id}">${value.nama}</a></td>
				...
				<td id="buStasiunPompa_50581" style="border: thin solid #006666;" class="number">${value.buJembatanPengambilan}</td>
				<td id="buEmbung_50581" style="border: thin solid #006666;" class="number">${value.buRmGensetPanelElektrikal}</td>
				...
				<td id="bpFlum_50581" style="border: thin solid #006666;" class="number">${value.blinKrib}</td>
				<td id="bpTerowongan_50581" style="border: thin solid #006666;" class="number">${value.blinPelimpah}</td>
				<td id="blinKantong_50581" style="border: thin solid #006666;" class="number">${value.blinSaluranGendong}</td>
				<td id="blinPelimpah_50581" style="border: thin solid #006666;" class="number">${value.blinPelepasTekan}</td>
				<td id="blinPenguras_50581" style="border: thin solid #006666;" class="number">${value.blinBakKontrol}</td>
				<td id="blinSaluranGendong_50581" style="border: thin solid #006666;" class="number">${value.blinTanggul}</td>
				<td id="blinKrib_50581" style="border: thin solid #006666;" class="number">${value.blinPerkuatanTebing}</td>
