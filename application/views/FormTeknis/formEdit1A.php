                            ...
                            <div class="row">
                                <div class="col-sm-3"> <!-- start box per input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="in_laPermen" name="laPermen" value="<?= str_replace('.', ',', $dataDi->lper); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" placeholder="Berdasarkan Permen 14/2015" readonly>
