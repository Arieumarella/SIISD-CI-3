                  ...
                  <div class="content-header bg-warning">
                    <div class="container-fluid">
                      ...
                      <div class="col-sm-5 text-right">
                        <a href="<?= base_url(); ?>FormTeknis/getDetailData1A/<?= $id; ?>" class="btn btn-default btn-sm" title="Batal"><i class="fas fa-file"></i> Batal</a>
                            ...
                            <div class="col-sm-6" data-select2-id="33"> <!-- start box per input -->
                                ...
                                <div class="form-group" data-select2-id="32">
                                    ...
                                    <select id="in_irigasiid" name="irigasiid" class="form-control select3" required>
                                        <option value="<?= $dataDi->id; ?>" selected><?= $dataDi->nama; ?></option>
                                    </select>
