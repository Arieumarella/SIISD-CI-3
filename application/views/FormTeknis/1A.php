  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row m-0 p-0 text-left">
        <div class="col-sm-3">
          <h5 class="m-0 text-dark" id="titleBox">Data Form 1A : ASET D.I.</h5>
        </div>
          ...
          <div class="row">
            ...
            <div class="row col-sm-12  col-lg-4 p-0 ml-1">
              ...
              <?php if ($this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'provinsi') { ?>
                ...
                <a href="<?= base_url(); ?>FormTeknis/TambahData" class="btn btn-primary mr-1" aksi="add" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>

                <a href="<?= base_url(); ?>FormTeknis/formExcelA1" class="btn btn-success" aksi="add" title="Tambah Data"><i class="fas fa-file-excel"></i> Format Excel</a>
          ...
          <table class="table table-bordered">  <!-- table-head-fixed -->
            <thead id="thead_data">
              <tr id="boxThField0" style="background-color:#18978F; color:#fff;">
                ...
                <th style="border: thin solid #006666;" colspan="7" rowspan="">Bangunan&nbsp;Pembawa</th>
                ...
                <th style="border: thin solid #006666;" colspan="4" rowspan="">Dokumentasi</th>
              </tr>
              ...
              <tr id="boxThField" style="background-color:#18978F; color:#fff;">
                ...
                <th style="border: thin solid #006666;">Pengambilan Bebas&nbsp;(bh)</th>                                                                         
                <th style="border: thin solid #006666;">Stasiun Pompa (bh)</th>                                                                           
                <th style="border: thin solid #006666;">Embung (bh)</th>                                                                            
                ...
                <th style="border: thin solid #006666;">Flum (bh)</th>                                                                                
                <th style="border: thin solid #006666;">Terowongan (bh)</th>                                                                                
                <th style="border: thin solid #006666;">Kantong Lumpur/Sedimen (bh)</th>                                                                               
                <th style="border: thin solid #006666;">Pelimpah (bh)</th>                                                                                
                <th style="border: thin solid #006666;">Penguras (bh)</th>                                                                               
  ...
  $(document).ready(function() {
    ...
    getDataTabel = async function (page=null, providX=null, kotakabidX=null) {
      try{
        ...
        ajaxUntukSemua(base_url()+'FormTeknis/getDataTable', {perhalaman, halamanSaatIni, search, provid, kotakabid}, function(data) {
    ...
    function setTabelKonten(data) {
     ...
     $.each(data, function(key, value) {
      ...
      <td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}FormTeknis/getDetailData1A/${value.irigasiidX}">${value.nama}</a></td>
      ...
      <td id="sumberAir_50581" style="border: thin solid #006666;" class="options">${cleanStr(value.sumberAir)}</td>
      <td id="buBendung_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.buBendung)}</td>
      <td id="buPengambilanBebas_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.buPengambilanBebas)}</td>
      <td id="buStasiunPompa_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.buStasiunPompa)}</td>
      <td id="buEmbung_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.buEmbung)}</td>
      <td id="sTipeSaluran_50581" style="border: thin solid #006666;" class="options">${cleanStr(value.sTipeSaluran)}</td>
      <td id="sPrimer_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.sPrimer)}</td>
      <td id="sSekunder_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.sSekunder)}</td>
      <td id="sTersier_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.sTersier)}</td>
      <td id="sPembuang_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.sPembuang)}</td>
      <td id="bppBagi_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bppBagi)}</td>
      <td id="bppBagiSadap_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bppBagiSadap)}</td>
      <td id="bppSadap_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bppSadap)}</td>
      <td id="bppBangunanPengukur_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bppBangunanPengukur)}</td>
      <td id="bpGorong_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bpGorong)}</td>
      <td id="bpSipon_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bpSipon)}</td>
      <td id="bpTalang_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bpTalang)}</td>
      <td id="bpTerjunan_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bpTerjunan)}</td>
      <td id="bpGotMiring_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bpGotMiring)}</td>
      <td id="bpFlum_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bpFlum)}</td>
      <td id="bpTerowongan_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bpTerowongan)}</td>
      <td id="blinKantong_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.blinKantong)}</td>
      <td id="blinPelimpah_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.blinPelimpah)}</td>
      <td id="blinPenguras_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.blinPenguras)}</td>
      <td id="blinSaluranGendong_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.blinSaluranGendong)}</td>
      <td id="blinKrib_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.blinKrib)}</td>
      <td id="blinPerkuatanTebing_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.blinPerkuatanTebing)}</td>
      <td id="blinTanggul_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.blinTanggul)}</td>
      <td id="bkapJalanInspeksi_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bkapJalanInspeksi)}</td>
      <td id="bkapJembatan_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bkapJembatan)}</td>
      <td id="bkapKantorPengamat_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bkapKantorPengamat)}</td>
      <td id="bkapGudang_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bkapGudang)}</td>
      <td id="bkapRumahJaga_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bkapRumahJaga)}</td>
      <td id="bkapElektrikal_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bkapElektrikal)}</td>
      <td id="bkapSanggarTani_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.bkapSanggarTani)}</td>
      <td id="saranaPintuAir_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.saranaPintuAir)}</td>
      <td id="saranaAlatUkur_50581" style="border: thin solid #006666;" class="number">${cleanStr(value.saranaAlatUkur)}</td>
      <td id="dokPeta_50581" style="border: thin solid #006666;" class="options">${cleanStr(value.dokPeta)}</td>
      <td id="dokSkemaJaringan_50581" style="border: thin solid #006666;" class="options">${cleanStr(value.dokSkemaJaringan)}</td>
      <td id="dokGambarKonstruksi_50581" style="border: thin solid #006666;" class="options">${cleanStr(value.dokGambarKonstruksi)}</td>
      <td id="dokBukuDataDI_50581" style="border: thin solid #006666;" class="options">${cleanStr(value.dokBukuDataDI)}</td>
      </tr>`;
...
$('#prov').change(function() {
  ...
  ajaxUntukSemua(base_url()+'FormTeknis/getDataKabKota', {prov}, function(data) {
