  ...
  $(document).ready(function() {
    ...
    function setTabelKonten(data) {
     ...
     $.each(data, function(key, value) {
      ...
      <td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}FormTeknis/getDetailData1A/${value.irigasiidX}">${cleanStr(value.nama)}</a></td>
      ...
      <td id="buBendung_50581" style="border: thin solid #006666; ${bgTabelKolom(value.buBendungx)}" class="number">${cleanStr(value.buBendung)}</td>
      <td id="buPengambilanBebas_50581" style="border: thin solid #006666; ${bgTabelKolom(value.buPengambilanBebasx)}" class="number">${cleanStr(value.buPengambilanBebas)}</td>
      <td id="buStasiunPompa_50581" style="border: thin solid #006666; ${bgTabelKolom(value.buStasiunPompax)}" class="number">${cleanStr(value.buStasiunPompa)}</td>
      <td id="buEmbung_50581" style="border: thin solid #006666; ${bgTabelKolom(value.buEmbungx)}" class="number">${cleanStr(value.buEmbung)}</td>
      ...
      <td id="bpFlum_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bpFlumx)}" class="number">${cleanStr(value.bpFlum)}</td>
      <td id="bpTerowongan_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bpTerowonganx)}" class="number">${cleanStr(value.bpTerowongan)}</td>
      <td id="blinKantong_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinKantongx)}" class="number">${cleanStr(value.blinKantong)}</td>
      <td id="blinPelimpah_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinPelimpahx)}" class="number">${cleanStr(value.blinPelimpah)}</td>
      <td id="blinPenguras_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinPengurasx)}" class="number">${cleanStr(value.blinPenguras)}</td>
      <td id="blinSaluranGendong_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinSaluranGendongx)}" class="number">${cleanStr(value.blinSaluranGendong)}</td>
      <td id="blinKrib_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinKribx)}" class="number">${cleanStr(value.blinKrib)}</td>
      <td id="blinPerkuatanTebing_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinPerkuatanTebingx)}" class="number">${cleanStr(value.blinPerkuatanTebing)}</td>
      <td id="blinTanggul_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinTanggulx)}" class="number">${cleanStr(value.blinTanggul)}</td>
      <td id="bkapJalanInspeksi_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bkapJalanInspeksix)}" class="number">${cleanStr(value.bkapJalanInspeksi)}</td>
      <td id="bkapJembatan_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bkapJembatanx)}" class="number">${cleanStr(value.bkapJembatan)}</td>
      <td id="bkapKantorPengamat_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bkapKantorPengamatx)}" class="number">${cleanStr(value.bkapKantorPengamat)}</td>
      <td id="bkapGudang_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bkapGudangx)}" class="number">${cleanStr(value.bkapGudang)}</td>
      <td id="bkapRumahJaga_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bkapRumahJagax)}" class="number">${cleanStr(value.bkapRumahJaga)}</td>
      <td id="bkapElektrikal_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bkapElektrikalx)}" class="number">${cleanStr(value.bkapElektrikal)}</td>
      <td id="bkapSanggarTani_50581" style="border: thin solid #006666; ${bgTabelKolom(value.bkapSanggarTanix)}" class="number">${cleanStr(value.bkapSanggarTani)}</td>
      <td id="saranaPintuAir_50581" style="border: thin solid #006666; ${bgTabelKolom(value.saranaPintuAirx)}" class="number">${cleanStr(value.saranaPintuAir)}</td>
      <td id="saranaAlatUkur_50581" style="border: thin solid #006666; ${bgTabelKolom(value.saranaAlatUkurx)}" class="number">${cleanStr(value.saranaAlatUkur)}</td>
      <td id="dokPeta_50581" style="border: thin solid #006666; ${bgTabelKolom(value.dokPetax)}" class="options">${cleanStr(value.dokPeta)}</td>
      <td id="dokSkemaJaringan_50581" style="border: thin solid #006666; ${bgTabelKolom(value.dokSkemaJaringanx)}" class="options">${cleanStr(value.dokSkemaJaringan)}</td>
      <td id="dokGambarKonstruksi_50581" style="border: thin solid #006666; ${bgTabelKolom(value.dokGambarKonstruksix)}" class="options">${cleanStr(value.dokGambarKonstruksi)}</td>
      <td id="dokBukuDataDI_50581" style="border: thin solid #006666; ${bgTabelKolom(value.dokBukuDataDIx)}" class="options">${cleanStr(value.dokBukuDataDI)}</td>
      </tr>`;
