...
<body class="m-0 p-0" id="bodyUtama">
    <div class="">
              ...
              <div class="content-header bg-warning">
                  <div class="container-fluid">
                    <div class="row m-0 p-0 text-left">
                      <div class="col-sm-7">
                        <h4 class="m-0" id="titleBox">Form 1F : PROGRES PAI</h4>
                    </div>

                    <div class="col-5 text-right">
                        <a href="<?= base_url(); ?>FormTeknis1F" class="btn btn-default btn-sm" aksi="table" title="Kembali"><i class="fas fa-home"></i> Kembali</a>
        ...
        <section class="content">
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="card-body p-0 ">
                  ...
                  <div class="modal-body html-content" id="DivIdToPrint">
                    ...
                    <div class="col-sm-6"> 
                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                            <div class="row p-0 m-0">
                                <label id="label_irigasiid" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_irigasiid" style="background-color:#e6e6e6;">Luas Daerah Irigasi Berdasarkan Permen 14/2015 (Ha)</label>
                                <div class="col-sm-6 pr-2 m-0 row">
                    ...
                    <div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
                        <div class="p-0 m-0" style="border:0px;">
                            <h5 class="card-title">Inventarisasi Aset Irigasi</h5>
                        </div>
                    </div>
                       ...
                       <div class="col-sm-6">
                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                            <div class="row p-0 m-0">
                                ...
                                <div class="col-sm-6 pr-2 m-0 row">
                                    <div class="" id="isi_laPermen"><?= str_replace('.', ',', $dataDi->tkpaiInvAsetIrigasiThn); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                            <div class="row p-0 m-0">
                                <label id="label_laBaku" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_laBaku" style="background-color:#e6e6e6;">%</label>
                                <div class="col-sm-6 pr-2 m-0 row">
                                    <div class="" id="isi_laBaku"><?= str_replace('.', ',', $dataDi->tkpaiInvAsetIrigasiPsen); ?></div>
                                </div>
                            </div>
                        </div>
                    </div> 
                ...
                <div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
                    <div class="p-0 m-0" style="border:0px;">
                        <h5 class="card-title">Perencanaan PAI</h5>
                    </div>
                </div>
                   ...
                   <div class="col-sm-6">
                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                        <div class="row p-0 m-0">
                            <label id="label_laPermen" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_laPermen" style="background-color:#e6e6e6;">Tahun</label>
                            <div class="col-sm-6 pr-2 m-0 row">
                                <div class="" id="isi_laPermen"><?= str_replace('.', ',', $dataDi->tkpaiPerencanaanPAIThn); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                        <div class="row p-0 m-0">
                            <label id="label_laBaku" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_laBaku" style="background-color:#e6e6e6;">%</label>
                            <div class="col-sm-6 pr-2 m-0 row">
                                <div class="" id="isi_laBaku"><?= str_replace('.', ',', $dataDi->tkpaiPerencanaanPAIPsen); ?></div>
                            </div>
                        </div>
                    </div>
                </div> 
            ...
            <div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
                <div class="p-0 m-0" style="border:0px;">
                    <h5 class="card-title">Pelaksanaan PAI</h5>
                </div>
            </div>
               ...
               <div class="col-sm-6">
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
                        <label id="label_laPermen" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_laPermen" style="background-color:#e6e6e6;">Tahun</label>
                        <div class="col-sm-6 pr-2 m-0 row">
                            <div class="" id="isi_laPermen"><?= str_replace('.', ',', $dataDi->tkpaiPelaksanaanPAIThn); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                    <div class="row p-0 m-0">
                        <label id="label_laBaku" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_laBaku" style="background-color:#e6e6e6;">%</label>
                        <div class="col-sm-6 pr-2 m-0 row">
                            <div class="" id="isi_laBaku"><?= str_replace('.', ',', $dataDi->tkpaiPelaksanaanPAIPsen); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
        ...
        <div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
            <div class="p-0 m-0" style="border:0px;">
                <h5 class="card-title">Evaluasi PAI</h5>
            </div>
        </div>
           ...
           <div class="col-sm-6">
            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                <div class="row p-0 m-0">
                    <label id="label_laPermen" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_laPermen" style="background-color:#e6e6e6;">Tahun</label>
                    <div class="col-sm-6 pr-2 m-0 row">
                        <div class="" id="isi_laPermen"><?= str_replace('.', ',', $dataDi->tkpaiEvaluasiPAIThn); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
                <div class="row p-0 m-0">
                    <label id="label_laBaku" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_laBaku" style="background-color:#e6e6e6;">%</label>
                    <div class="col-sm-6 pr-2 m-0 row">
                        <div class="" id="isi_laBaku"><?= str_replace('.', ',', $dataDi->tkpaiEvaluasiPAIPsen); ?></div>
                    </div>
                </div>
            </div>
        </div> 
    ...
    <div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
        <div class="p-0 m-0" style="border:0px;">
            <h5 class="card-title">Pemutakhiran Hasil Invent. AI</h5>
        </div>
    </div>
       ...
       <div class="col-sm-6">
        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
            <div class="row p-0 m-0">
                <label id="label_laPermen" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_laPermen" style="background-color:#e6e6e6;">Tahun</label>
                <div class="col-sm-6 pr-2 m-0 row">
                    <div class="" id="isi_laPermen"><?= str_replace('.', ',', $dataDi->tkpaiPethirHasilInventAIThn); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6">
        <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
            <div class="row p-0 m-0">
                <label id="label_laBaku" class="ml-2 col-sm-5 p-0 m-0 labelTh" idinput="isi_laBaku" style="background-color:#e6e6e6;">%</label>
                <div class="col-sm-6 pr-2 m-0 row">
                    <div class="" id="isi_laBaku"><?= str_replace('.', ',', $dataDi->tkpaiPethirHasilInventAIPsen); ?></div>
                </div>
            </div>
        </div>
    </div> 
...
<div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
    <div class="p-0 m-0" style="border:0px;">
        <h5 class="card-title">TAHAPAN KEGIATAN PENGELOLAAN ASET IRIGASI</h5>
    </div>
</div>
   ...
   <div class="col-sm-6">
    <div class="form-group p-0" style="border-bottom:1px solid #ccc;">
        <div class="row p-0 m-0">
            ...
            <div class="col-sm-6 pr-2 m-0 row">
                <div class="" id="isi_laPermen"><?= str_replace('.', ',', $dataDi->keterangan); ?></div>
            </div>
        </div>
    </div>
</div>
  ...
  $(document).ready(function(){
    ...
    deleteData = function (id) {
        ...
        if (result.value) {
            ...
            $.ajax({
                url: base_url()+'FormTeknis1F/delete',
                type: "post",
                dataType: 'json',
                data: {id},
                ...
                window.location = base_url()+'FormTeknis1F';
