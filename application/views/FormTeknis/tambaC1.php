        ...
        <div class="" data-select2-id="28"> <!-- content-wrapper -->
            ...
            <div class="row m-0" data-select2-id="27">
              ...
              <div class="col-lg-12 p-0" data-select2-id="26">
                <form role="form" action="<?= base_url(); ?>FormTeknis1C/SimpanDataC1" method="POST" data-select2-id="25">
                  ...
                  <div class="content-header bg-warning">
                    <div class="container-fluid">
                      ...
                      <div class="col-sm-5 text-right">
                        <a href="<?= base_url(); ?>FormTeknis1C" class="btn btn-default btn-sm" title="Kembali"><i class="fa fa-undo"></i> Kembali</a>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input id="buSumur" name="buSumur" value="" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Sumur (bh)">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input id="buRumah" name="buRumah" value="" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Rumah Genset/Panel">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input id="buElektrikal" name="buElektrikal" value="" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Elektrikal (bh)">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3"> 
                                    <div class="form-group">
                                        ...
                                        <input id="blinTanggul" name="blinTanggul" value="" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Tanggul (m)">
...
<script>
  $(document).ready(function(){
    ...
    $('#in_irigasiid').on('change', function() {
        ...
        $.ajax({
            url: base_url()+'FormTeknis1C/getLapermen', 
            method: 'POST',
            data: {irigasiid:val},
            dataType: 'json',
