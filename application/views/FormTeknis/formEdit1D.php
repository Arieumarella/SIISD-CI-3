    ...
    <div class="" data-select2-id="28"> <!-- content-wrapper -->
        ...
        <div class="row m-0" data-select2-id="27">
          ...
          <div class="col-lg-12 p-0" data-select2-id="26">
            <form role="form" action="<?= base_url(); ?>FormTeknis1D/SimpanDataEdit" method="POST" data-select2-id="25">
              ...
              <div class="content-header bg-warning">
                <div class="container-fluid">
                  ...
                  <div class="col-sm-5 text-right">
                    <a href="<?= base_url(); ?>FormTeknis1D/getDetailData/<?= $id; ?>" class="btn btn-default btn-sm" title="Kembali"><i class="fa fa-undo"></i> Kembali</a>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="buPengambilanAirTawar" name="buPengambilanAirTawar" value="<?= str_replace('.', ',', $dataDi->buPengambilanAirTawar); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Pengambilan Air Tawar (bh)">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="buPengambilanAirAsin" name="buPengambilanAirAsin" value="<?= str_replace('.', ',', $dataDi->buPengambilanAirAsin); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Pengambilan Air Asin (bh)">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="buStasiunPompa" name="buStasiunPompa" value="<?= str_replace('.', ',', $dataDi->buStasiunPompa); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Stasiun Pompa (bh)">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3"> 
                                <div class="form-group">
                                    ...
                                    <input id="blinPerkuatanTebing" name="blinPerkuatanTebing" value="<?= str_replace('.', ',', $dataDi->blinPerkuatanTebing); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Perkuatan Tebing (m)">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="bkapJembatan" name="bkapJembatan" value="<?= str_replace('.', ',', $dataDi->bkapJembatan); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Jembatan (bh)">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="bkapElektrikal" name="bkapElektrikal" value="<?= str_replace('.', ',', $dataDi->bkapElektrikal); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Rumah Genset/Panel Elektrikal (bh)">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="bkapKolamTandon" name="bkapKolamTandon" value="<?= str_replace('.', ',', $dataDi->bkapKolamTandon); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Kolam Tandon (bh)">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="bkapKolamPengendap" name="bkapKolamPengendap" value="<?= str_replace('.', ',', $dataDi->bkapKolamPengendap); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Kolam Pengendap (bh)">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="bkapKolamPencampur" name="bkapKolamPencampur" value="<?= str_replace('.', ',', $dataDi->bkapKolamPencampur); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Kolam Pencampur (bh)">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input id="bkapJetti" name="bkapJetti" value="<?= str_replace('.', ',', $dataDi->bkapJetti); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Jetti (m)">
