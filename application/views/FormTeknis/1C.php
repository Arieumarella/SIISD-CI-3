	...
	$(document).ready(function() {
		...
		function setTabelKonten(data) {
			...
			$.each(data, function(key, value) {
				...
				<td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}FormTeknis1C/getDetailData/${value.irigasiidX}">${cleanStr(value.nama)}</a></td>
				...
				<td id="sumberAir_50581" style="border: thin solid #006666; ${bgTabelKolom(value.buSumurx)} " class="options">${cleanStr(value.buSumur)}</td>
				...
				<td id="buStasiunPompa_50581" style="border: thin solid #006666; ${bgTabelKolom(value.buRumahx)} " class="number">${cleanStr(value.buRumah)}</td>
				<td id="buEmbung_50581" style="border: thin solid #006666; ${bgTabelKolom(value.buElektrikalx)} " class="number">${cleanStr(value.buElektrikal)}</td>
				...
				<td id="bpFlum_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinPelimpahx)} " class="number">${cleanStr(value.blinPelimpah)}</td>
				<td id="bpTerowongan_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinSaluranGendongx)} " class="number">${cleanStr(value.blinSaluranGendong)}</td>
				<td id="blinKantong_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinPelepasTekanx)} " class="number">${cleanStr(value.blinPelepasTekan)}</td>
				<td id="blinPelimpah_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinBakKontrolx)} " class="number">${cleanStr(value.blinBakKontrol)}</td>
				<td id="blinPenguras_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinTanggulx)} " class="number">${cleanStr(value.blinTanggul)}</td>
				<td id="blinSaluranGendong_50581" style="border: thin solid #006666; ${bgTabelKolom(value.blinPerkuatanTebingx)} " class="number">${cleanStr(value.blinPerkuatanTebing)}</td>
				...
				<td id="blinKrib_50581" style="border: thin solid #006666; ${bgTabelKolom(value.dokPetax)} " class="">${cleanStr(value.dokPeta)}</td>
				<td id="blinKrib_50581" style="border: thin solid #006666; ${bgTabelKolom(value.dokSkemaJaringanx)} " class="">${cleanStr(value.dokSkemaJaringan)}</td>
				<td id="blinKrib_50581" style="border: thin solid #006666; ${bgTabelKolom(value.dokGambarKonstruksix)} " class="">${cleanStr(value.dokGambarKonstruksi)}</td>
				<td id="blinKrib_50581" style="border: thin solid #006666; ${bgTabelKolom(value.dokBukuDataDIx)} " class="">${cleanStr(value.dokBukuDataDI)}</td>
				</tr>`;
