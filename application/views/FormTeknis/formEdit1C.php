    ...
    <div class="" data-select2-id="28"> <!-- content-wrapper -->
        ...
        <div class="row m-0" data-select2-id="27">
          ...
          <div class="col-lg-12 p-0" data-select2-id="26">
            <form role="form" action="<?= base_url(); ?>FormTeknis1C/SimpanDataEdit" method="POST" data-select2-id="25">

              <div class="content-header bg-warning">
                <div class="container-fluid">
                  <div class="row m-0 p-0 text-left">
                    <div class="col-sm-7">
                      <h4 class="m-0">Form 1C : ASET D.I.A.T</h4>
                  </div>

                  <div class="col-sm-5 text-right">
                    <a href="<?= base_url(); ?>FormTeknis1C/getDetailData/<?= $id; ?>" class="btn btn-default btn-sm" title="Kembali"><i class="fa fa-undo"></i> Kembali</a>
                    ...
                    <div class="modal-body" data-select2-id="20">
                        ...
                        <div class="col-sm-6" data-select2-id="33"> <!-- start box per input -->
                            ...
                            <div class="form-group" data-select2-id="32">
                                <label for="in_irigasiid">Nomeklatur/ Nama  D.I.A.T  <span class="text-danger" title="Wajib di Isi">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="buSumur">Sumur (bh)</label>
                                    <input id="buSumur" name="buSumur" value="<?= str_replace('.', ',', $dataDi->buSumur); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Sumur (bh)">
                                    <div class="invalid-feedback" id="pesan_in_buSumur"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="buRumah">Rumah Genset/Panel</label>
                                    <input id="buRumah" name="buRumah" value="<?= str_replace('.', ',', $dataDi->buRumah); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Rumah Genset/Panel">
                                    <div class="invalid-feedback" id="pesan_buRumah"></div>
                                </div>
                            </div>

                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="buElektrikal">Elektrikal (bh)</label>
                                    <input id="buElektrikal" name="buElektrikal" value="<?= str_replace('.', ',', $dataDi->buElektrikal); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Elektrikal (bh)">
                                    <div class="invalid-feedback" id="pesan_buElektrikal"></div>
                                </div>
                            </div>
                        </div>
                        <!-- End Row Bangunan Utama -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3"> 
                                <div class="form-group">
                                    <label for="blinTanggul">Tanggul (m)</label>
                                    <input id="blinTanggul" name="blinTanggul" value="<?= str_replace('.', ',', $dataDi->blinTanggul); ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9,]/g, '')" required placeholder="Tanggul (m)">
  ...
  $(document).ready(function(){
    ...
    <?php if ($this->session->userdata('prive') == 'admin') { ?> 
        ...
        $('.select3').select2({
          ...
          theme: 'default',
          ajax: {
            url: base_url() + "FormTeknis1C/getDiTambahData",
            dataType: 'json',
            type: 'post',
            delay: 250,
