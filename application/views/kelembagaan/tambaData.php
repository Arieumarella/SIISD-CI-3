    ...
    <div class="" data-select2-id="28"> <!-- content-wrapper -->
        ...
        <div class="row m-0" data-select2-id="27">
          ...
          <div class="col-lg-12 p-0" data-select2-id="26">
            <form role="form" action="<?= base_url(); ?>Kelembagaan/SimpanData" method="POST" data-select2-id="25">
          ...
          <div class="row">
            <div class="card-body p-0 ">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                    <form method="POST" action="<?= base_url(); ?>Kelembagaan/SimpanData">
                                ...
                                <?php foreach ($dataLabel as $key => $value) { ?>
                                    ...
                                    <tr id="tr_aLabel_9">
                                        ...
                                        <td class="col-sm-3" style="min-width:100px; max-width:10%; ">
                                            <input id="in_noSuratOrPeraturan" name="noSuratOrPeraturan[]" value="" type="text" class="form-control form-control-sm" placeholder="Nomor Surat/Peraturan">
                                            <div class="invalid-feedback" id="pesan_noSuratOrPeraturan"></div>


                                        </td>
                                        <td class="col-sm-3" style="min-width:100px; max-width:10%; ">
                                            <input id="in_thnSuratOrPeraturan" name="thnSuratOrPeraturan[]" value="" type="text" class="form-control form-control-sm" placeholder="Tahun Surat/Peraturan">
                                            <div class="invalid-feedback" id="pesan_thnSuratOrPeraturan"></div>


                                        </td>
                                        <td class="col-sm-3" style="min-width:250px; max-width:30%; ">
                                            <input id="in_keterangan" name="keterangan[]" value="" type="text" class="form-control form-control-sm" placeholder="Keterangan">
...
<script>
  ...
  }).next(".select2-container").find(".select2-selection").addClass('select-sm');
