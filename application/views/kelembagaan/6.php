	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row m-0 p-0 text-left">
				<div class="col-sm-3">
					<h5 class="m-0 text-dark" id="titleBox">Data Form 6 : KELEMBAGAAN</h5>
				</div>
				...
				<div class="col-sm-12 mt-2">
					...
					<div class="row">
						...
						<div class="row col-sm-12  col-lg-4 p-0 ml-0" style="margin-left: -50px;">
							...
							<?php if ($this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'provinsi') { ?>
								...
								<a href="<?= base_url(); ?>Kelembagaan/TambahData" class="btn btn-primary mr-1" style="margin-left: 50px;" aksi="add" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>
								<a href="<?= base_url(); ?>Kelembagaan/downloadTabel" class="btn btn-info mr-1" title="Unduh"><i class="fas fa-file-excel"></i> Unduh</a>
				...
				<div class="card-body table-responsive p-0 tableFixHead" style="position: relative; overflow-y: scroll; height: 83vh; background-color:#efebe9; padding:2px;">
					...
					<table class="table table-bordered">
						...
						<thead id="thead_data">
							...
							<tr id="boxThField" style="background-color:#18978F; color:#fff;"></tr>
	...
	$(document).ready(function() {
		...
		getDataTabel = async function(page = null, providX = null, kotakabidX = null) {
			try {
				...
				ajaxUntukSemua(base_url() + 'Kelembagaan/getDataTable', {
					perhalaman,
					halamanSaatIni,
					search,
					provid,
		...
		function setTabelKonten(data) {
			...
			$.each(data, function(key, value) {
				...
				<td id="irigasiid_50581" style="border: thin solid #006666;" class="options menuALink"><a href="${base_url()}Kelembagaan/getDetailData/${value.id}">${value.kemendagri}</a></td>
				</tr>`;
		...
		$('#prov').change(function() {
			...
			ajaxUntukSemua(base_url() + 'Kelembagaan/getDataKabKota', {
				prov
			}, function(data) {
