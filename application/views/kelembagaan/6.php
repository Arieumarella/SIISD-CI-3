...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		getDataTabel = async function (page=null, providX=null, kotakabidX=null) {
			try{
				...
				ajaxUntukSemua(base_url()+'Kelembagaan/getDataTable', {perhalaman, halamanSaatIni, search, provid, kotakabid}, function(data) {
  ...
  // Menampilkan tombol First
		...
		$('#prov').change(function() {
			...
			ajaxUntukSemua(base_url()+'Kelembagaan/getDataKabKota', {prov}, function(data) {
