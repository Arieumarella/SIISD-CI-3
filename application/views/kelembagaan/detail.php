              ...
              <div class="content-header bg-warning">
                  <div class="container-fluid">
                    <div class="row m-0 p-0 text-left">
                      <div class="col-sm-7">
                        <h4 class="m-0" id="titleBox">Form 6 : KELEMBAGAAN</h4>
                    </div>

                    <div class="col-5 text-right">
                        <a href="<?= base_url(); ?>Kelembagaan" class="btn btn-default btn-sm" aksi="table" title="Kembali"><i class="fas fa-home"></i> Kembali</a>

                        <?php if ($this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'provinsi') { ?>

                            <a href="<?= base_url(); ?>Kelembagaan/editData/<?= $id; ?>" class="btn btn-primary btn-sm" aksi="ubah" title="Ubah data"><i class="far fa-edit"></i> Ubah</a>
                  ...
                  <div class="modal-body html-content" id="DivIdToPrint">
                    ...
                    <div class="mb-2 p-1" style="background-color:#ccc; border:0px;">
                        <div class="p-0 m-0" style="border:0px;">
                            <h5 class="card-title">Kelembagaan</h5>
                        </div>
                    </div>
                    <table class="table" border="1" style="font-size:12px;">
                        <thead>
                            <tr>
                                ...
                                <th colspan="1" rowspan="1" class="text-center">Kelengkapan</th>
                                <th colspan="1" rowspan="1" class="text-center">Ada/Tidak Ada</th>
                                <th colspan="1" rowspan="1" class="text-center">Nomor Surat/Peraturan</th>
                                <th colspan="1" rowspan="1" class="text-center">Tahun Surat/Peraturan</th>
                        ...
                        <tbody id="boxTable">
                            ...
                            <?php foreach ($dataBody as $key => $value) { ?>
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><?= $value->label; ?></td>
                                    <td><?= $value->stKelengkapan; ?></td>
                                    <td><?= $value->noSuratOrPeraturan; ?></td>
                                    <td><?= $value->thnSuratOrPeraturan; ?></td>
  ...
  $(document).ready(function(){
    ...
    deleteData = function (id) {
        ...
        if (result.value) {
            ...
            $.ajax({
                url: base_url()+'Kelembagaan/delete',
                type: "post",
                dataType: 'json',
                data: {id},
                ...
                window.location = base_url()+'Kelembagaan';
