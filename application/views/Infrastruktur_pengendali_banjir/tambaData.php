  ...
  <div class=""> <!-- content-wrapper -->
    <div class="" data-select2-id="28"> <!-- content-wrapper -->
        ...
        <div class="row m-0" data-select2-id="27">
          ...
          <div class="col-lg-12 p-0" data-select2-id="26">
            <form role="form" action="<?= base_url(); ?>InfrastrukturPBanjir/SimpanData" method="POST" data-select2-id="25">
    ...
    <section class="content">
          ...
          <div class="row">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3"> 
                        <div class="form-group" data-select2-id="32">
                            ...
                            <select id="ws" name="ws" class="form-control select2" required>
                                ...
                                <?php foreach ($dataWS as $key => $value) { ?>
                                <option value="<?= $value->id_ws; ?>"><?= $value->nm_ws; ?></option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input id="laDas" name="laDas" value="" type="text" class="form-control  text-right number" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" required placeholder="Luas DAS (Ha)">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input id="administartif" name="administartif" value="" type="text" class="form-control  text-right number" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" required placeholder="Wilayah Administratif">
                            <div class="invalid-feedback" id="pesan_laPermen"></div>
                        </div>                      
                    </div> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                         ...
                         <input id="bendungan" name="bendungan"  value="" type="text" class="form-control text-right number areaTerdampakJarIrigasiT" required placeholder="Bendungan (Bh)" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); arealTerdampak()">
                 ...
                 <div class="col-sm-3">
                    <div class="form-group">
                       ...
                       <input id="bendung" name="bendung"  value="" type="text" class="form-control text-right number areaTerdampakJarIrigasiT" required placeholder="Bendung (Bh)" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); arealTerdampak()">
               ...
               <div class="col-sm-3">
                <div class="form-group">
                   ...
                   <input id="tanggulSungai" name="tanggulSungai"  value="" type="text" class="form-control text-right number areaTerdampakJarIrigasiT" required placeholder="Tanggul Sungai (m)" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); arealTerdampak()">
           ...
           <div class="col-sm-3">
            <div class="form-group">
             ...
             <input id="kolamRetensi" name="kolamRetensi"  value="" type="text" class="form-control text-right number areaTerdampakJarIrigasiT" required placeholder="Kolom Retensi (Bh)" oninput="this.value = this.value.replace(/[^0-9,]/g, ''); arealTerdampak()">
     ...
     <div class="col-sm-3"> 
        <div class="form-group">
            ...
            <input id="perkuatanTebingSungai" value="" name="perkuatanTebingSungai"  type="text" class="form-control kududisabled" required placeholder="Perkuatan Tebing Sungai (m)">
    ...
    <div class="col-sm-3"> 
        <div class="form-group">
            ...
            <input id="sudetanKanalBanjir" value="" name="sudetanKanalBanjir"  type="text" class="form-control kududisabled" required placeholder="Sudetan / Kanal Banjir (m)">
            <div class="invalid-feedback" id="pesan_areaTerdampakJarIrigasiT"></div>
        </div>
    </div>
    ...
    <div class="col-sm-3"> 
        <div class="form-group">
            ...
            <input id="checkDam" value="" name="checkDam"  type="text" class="form-control kududisabled" required placeholder="Check DAM (Bh) ">
            <div class="invalid-feedback" id="pesan_areaTerdampakJarIrigasiT"></div>
        </div>
    </div>
    ...
    <div class="col-sm-3"> 
        <div class="form-group">
            ...
            <input id="Groundsill" value="" name="Groundsill"  type="text" class="form-control kududisabled" required placeholder="Grounsill (Bh) ">
            <div class="invalid-feedback" id="pesan_areaTerdampakJarIrigasiT"></div>
        </div>
    </div>
