        ...
        <div class="" data-select2-id="28"> <!-- content-wrapper -->
            ...
            <div class="row m-0" data-select2-id="27">
                ...
                <div class="col-lg-12 p-0" data-select2-id="26">
                    <form role="form" action="<?= base_url(); ?>EPAKSI/SimpanDataEdit" method="POST" data-select2-id="25">
                                    ...
                                    <div class="card-body p-0 " data-select2-id="21">
                                        ...
                                        <div class="modal-body" data-select2-id="20">
                                            ...
                                            <div class="bg-info mb-2" style="padding:2px; margin:0px;">
                                                <div class="" style="padding:0px 0px 0px 4px; margin:0px;">Tahun Pelaksanaan e-PAKSI</div>
                                            </div>
                                            ...
                                            <div id="boxAttr" class="col-sm-12">
                                                <?php foreach ($dataBody as $key => $val) { ?>
                                                    <div class="row mb-1 p-1" id="boxAttrIsi1" style="border:thin solid #b6b6b6;">
                                                        ...
                                                        <input type="hidden" name="idBody[]" value="<?= $val->id; ?>">
                                                        ...
                                                        <div class="row" data-select2-id="8">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="tahunPlaksana[]" value="<?= $val->tahunPlaksana; ?>" type="text" class="form-control form-control-sm" placeholder="Tahun Pelaksanaan" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                                                            ...
                                                            <div class="col-sm-2" data-select2-id="7">
                                                                ...
                                                                <div class="form-group" data-select2-id="6">
                                                                    ...
                                                                    <select name="stKontrak[]" class="form-control form-control-sm select2" required>
                                                                        ...
                                                                        <option value="K" <?= $val->stKontrak == 'K' ? 'selected' : ''; ?>>Kontraktual</option>
                                                                        <option value="S" <?= $val->stKontrak == 'S' ? 'selected' : ''; ?>>Swakelola</option>
                                                                    </select>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="namaKonsultan[]" value="<?= $val->namaKonsultan; ?>" type="text" class="form-control form-control-sm" placeholder="Nama Konsultan" required>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="nomorKontrak[]" value="<?= $val->nomorKontrak; ?>" type="text" class="form-control form-control-sm" placeholder="Nomor Kontrak" required>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="tanggalKontrak[]" value="<?= $val->tanggalKontrak; ?>" type="text" class="form-control form-control-sm datepicker" placeholder="Tanggal Kontrak" readonly="readonly" style="cursor: pointer; background: white;" required>
                                                            ...
                                                            <div class="col-sm-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="in_lamaPelaksanaan" name="lamaPelaksanaan[]" value="<?= $val->lamaPelaksanaan; ?>" type="text" class="form-control form-control-sm text-right number" oninput="this.value = this.value.replace(/[^0-9.,]/g, '')" placeholder="Pelaksanaan (Bulan)" required>
                                            ...
                                            <div id="boxAttrBtn">
                                                <div class="" style="width: 100%; relative: fixed; text-align:right;">
                                                    <buttom class="btn btn-warning btn-sm btn-efek" onclick="addRow()"> tambah</buttom>
                                                </div>
                                            </div>
