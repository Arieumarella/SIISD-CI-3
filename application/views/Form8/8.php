	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row m-0 p-0 text-left">
				<div class="col-sm-3">
					<h5 class="m-0 text-dark" id="titleBox">Data Form 8 : E-PAKSI</h5>
				</div>
					...
					<div class="row">
						...
						<div class="row col-sm-12  col-lg-4 p-0 ml-1">
							...
							<?php if ($this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'pemda') { ?>
								...
								<!-- <a href="<?= base_url(); ?>EPAKSI/downloadTabel" class="btn btn-info mr-1"><i class="fas fa-file-excel"></i> Unduh</a> -->
							...
							<?php if ($this->session->userdata('prive') == 'admin' or $this->session->userdata('prive') == 'pemda' or $this->session->userdata('prive') == 'provinsi') { ?>
								...
								<a href="<?= base_url(); ?>EPAKSI/TambahData" class="btn btn-primary mr-1" aksi="add" title="Tambah Data"><i class="fas fa-plus"></i> Tambah</a>

								<!-- <a href="<?= base_url(); ?>EPAKSI/formExcel" class="btn btn-success" aksi="add" title="Tambah Data"><i class="fas fa-file-excel"></i> Format Excel</a> -->
					...
					<table class="table table-bordered">
						...
						<thead id="thead_data">
							<tr id="boxThField0" style="background-color:#18978F; color:#fff;">
								...
								<th style="border: thin solid #006666;" colspan="31" rowspan="1">Tahun Pelaksanaan e-PAKSI</th>
							</tr>
							<tr id="boxThField1" style="background-color:#18978F; color:#fff;">
								<th style="border: thin solid #006666;" colspan="6" rowspan="1"><?= $data5Tahun[4]; ?></th>
								<th style="border: thin solid #006666;" colspan="6" rowspan="1"><?= $data5Tahun[3]; ?></th>
								<th style="border: thin solid #006666;" colspan="6" rowspan="1"><?= $data5Tahun[2]; ?></th>
								<th style="border: thin solid #006666;" colspan="6" rowspan="1"><?= $data5Tahun[1]; ?></th>
								<th style="border: thin solid #006666;" colspan="6" rowspan="1"><?= $data5Tahun[0]; ?></th>
							</tr>
							<tr id="boxThField2" style="background-color:#18978F; color:#fff;">
								<th style="border: thin solid #006666;" colspan="3" rowspan="1">Kontraktual</th>
								<th style="border: thin solid #006666;" colspan="3" rowspan="1">Swakelola</th>
								<th style="border: thin solid #006666;" colspan="3" rowspan="1">Kontraktual</th>
								<th style="border: thin solid #006666;" colspan="3" rowspan="1">Swakelola</th>
								<th style="border: thin solid #006666;" colspan="3" rowspan="1">Kontraktual</th>
								<th style="border: thin solid #006666;" colspan="3" rowspan="1">Swakelola</th>
							...
							<tr id="boxThField" style="background-color:#18978F; color:#fff;">
								<th style="border: thin solid #006666;">Tahun Pelaksanaan</th>                                       
								<th style="border: thin solid #006666;">Status Kontrak</th>                                       
								<th style="border: thin solid #006666;">Nama Konsultan</th>                                       
								<th style="border: thin solid #006666;">Nomor Kontrak</th>                                       
								<th style="border: thin solid #006666;">Tanggal Kontrak</th>                                        
								<th style="border: thin solid #006666;">Pelaksanaan (Bulan)</th>                                              
								<th style="border: thin solid #006666;">Tahun Pelaksanaan</th>                                        
								<th style="border: thin solid #006666;">Status Kontrak</th>                                        
								<th style="border: thin solid #006666;">Nama Konsultan</th>                                        
								<th style="border: thin solid #006666;">Nomor Kontrak</th>                                        
	...
	$(document).ready(function() {
		...
		getDataTabel = async function (page=null, providX=null, kotakabidX=null) {
			try{
				...
				ajaxUntukSemua(base_url()+'EPAKSI/getDataTable', {perhalaman, halamanSaatIni, search, provid, kotakabid}, function(data) {
		...
		function setTabelKonten(data) {
			...
			$.each(data, function(key, value) {
				...
				<td id="laPermen_50581" style="border: thin solid #006666;" class="number">${value.tanggalKontrak5 == null ? '': value.tanggalKontrak5}</td>
				<td id="laPermen_50581" style="border: thin solid #006666;" class="number">${value.lamaPelaksanaan5 == null ? '': value.lamaPelaksanaan5}</td>
...
$('#prov').change(function() {
	...
	ajaxUntukSemua(base_url()+'EPAKSI/getDataKabKota', {prov}, function(data) {
