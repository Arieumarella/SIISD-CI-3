...
class FormTeknis1C extends CI_Controller {
	...
	public function index()
	{
		...
		$tmp = array(
			...
			'prov' => ($this->session->userdata('prive') != 'balai') ? $this->M_dinamis->add_all('m_prov', '*', 'provid', 'asc') : $this->M_formTeknis1C->getProvBalai(),
	...
	public function getDataKabKota()
	{
		...
		if ($this->session->userdata('prive') != 'balai') {
			...
			$data = $this->M_formTeknis1C->getkabKota($prov);
		}
	...
	public function SimpanDataC1()
	{
		...
		$this->M_dinamis->delete('p_f1c', ['irigasiid' => $irigasiid, 'ta' => $thang]);
	...
	public function delete()
	{
		...
		$pros = $this->M_dinamis->delete('p_f1c', ['irigasiid' => $id, 'ta' => $thang]);
	...
	public function SimpanDataEdit()
	{
		...
		$this->M_dinamis->delete('p_f1c', ['irigasiid' => $id1B, 'ta' => $thang]);
		$pros = $this->M_dinamis->save('p_f1c', $dataInsert);
	...
	public function downloadTabel($kotakabid=null)
	{
		...
		$data = $this->M_formTeknis1C->getDataDownload($thang, $prive, $kotakabid);
