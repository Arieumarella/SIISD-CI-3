...
class FormTeknis extends CI_Controller {
	...
	public function SimpanData1A()
	{
		...
		redirect('/FormTeknis/TambahData', 'refresh');
	...
	public function deleteA1()
	{
		...
		$pros = $this->M_dinamis->delete('p_f1a', ['id' => $id]);
	...
	public function SimpanData1AEdit()
	{
		...
		$pros = $this->M_dinamis->update('p_f1a', $dataInsert, ['id' => $idA1]);
		...
		redirect("/FormTeknis/editDataA1/$idA1", 'refresh');
	...
	public function downloadExcelA1()
	{
		...
		$cek = $this->M_dinamis->getById('p_f1a', ['kotakabid' => $kab]);
