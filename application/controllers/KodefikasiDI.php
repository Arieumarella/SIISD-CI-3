...
class KodefikasiDI extends CI_Controller {
	...
	public function getDetailData($id=null)
	{
		$tmp = array(
			...
			'dataDi' => $this->M_PengkodeanIrigasiId->getDataDiById($id)
		);

		$this->load->view('PengkodeanIrigasiId/detailF1', $tmp);
	}
	...
	public function editData($id=null)
	{
		...
		$this->load->view('PengkodeanIrigasiId/formEdit1F', $tmp);
	}
	...
	public function SimpanDataEdit()
	{
		...
		redirect("/PengkodeanIrigasiId1F", 'refresh');
	...
	public function formExcel()
	{
		...
		$this->load->view('PengkodeanIrigasiId/excelF1', $tmp);
	}
	...
	public function downloadExcel()
	{
		...
		if ($cek) {
			$data = $this->M_PengkodeanIrigasiId->getDataDiFull($thang, $kab);
		}else{
			$thang = $thang-1;
			$data = $this->M_PengkodeanIrigasiId->getDataDiFull((string)$thang, $kab);
		}
	...
	public function prosesUploadExcel()
	{
		...
		if ($kab == null or $kab == '') {
			...
			redirect("/PengkodeanIrigasiId1F/formExcel", 'refresh');
		}
	...
	public function downloadTabel($kotakabid=null)
	{
		...
		$data = $this->M_PengkodeanIrigasiId->getDataDownload($thang, $prive, $kotakabid);
