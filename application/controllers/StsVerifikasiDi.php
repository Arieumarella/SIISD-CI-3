...
class StsVerifikasiDi extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model('M_stsVerifikasiDataTeknis');
	}
	...
	public function index()
	{
		...
		$tmp = array(
			'tittle' => 'Verifikasi DI',
			'footer_content' => 'footer_content',
			'NavbarTop' => 'NavbarTop',
			'NavbarLeft' => 'NavbarLeft',
			'prov' =>  ($this->session->userdata('prive') != 'balai') ? $this->M_dinamis->add_all('m_prov', '*', 'provid', 'asc') : $this->M_stsVerifikasiDataTeknis->getProvBalai(),
			'content' => 'stsVerifikasiDataTeknis/index'
		);
	...
	public function getDataTable()
	{
		...
		$data = $this->M_stsVerifikasiDataTeknis->getDataTable($jumlahDataPerHalaman, $search, $offset, $provid, $kotakabid);
	...
	public function getDi()
	{
		...
		$data = $this->M_stsVerifikasiDataTeknis->getDataDi($searchDi, $kdprov, $kdKab);
	...
	public function getDataKabKota()
	{
		...
		if ($this->session->userdata('prive') != 'balai') {
			...
			$data = $this->M_stsVerifikasiDataTeknis->getkabKota($prov);
		}
	...
	public function TambahData()
	{
		...
		$this->load->view('stsVerifikasiDataTeknis/tambaD1', $tmp);
	}
	...
	public function getDiTambahData()
	{
		...
		$data = $this->M_stsVerifikasiDataTeknis->getDataDiTambah($searchDi);
	...
	public function SimpanData()
	{
		...
		redirect('/stsVerifikasiDataTeknis1D', 'refresh');
	...
	public function getDetailData($id=null)
	{
		$tmp = array(
			...
			'dataDi' => $this->M_stsVerifikasiDataTeknis->getDataDiById($id)
		);

		$this->load->view('stsVerifikasiDataTeknis/detailD1', $tmp);
	}
	...
	public function editData($id=null)
	{
		...
		$this->load->view('stsVerifikasiDataTeknis/formEdit1D', $tmp);
	}
	...
	public function formExcel()
	{
		...
		$this->load->view('stsVerifikasiDataTeknis/excelD1', $tmp);
	}
	...
	public function downloadExcel()
	{
		...
		if ($cek) {
			$data = $this->M_stsVerifikasiDataTeknis->getDataDiFull($thang, $kab);
		}else{
			$thang = $thang-1;
			$data = $this->M_stsVerifikasiDataTeknis->getDataDiFull((string)$thang, $kab);
		}
	...
	public function prosesUploadExcel()
	{
		...
		if ($kab == null or $kab == '') {
			...
			redirect("/stsVerifikasiDataTeknis1D/formExcel", 'refresh');
		}
	...
	public function downloadTabel($kotakabid=null)
	{
		...
		$data = $this->M_stsVerifikasiDataTeknis->getDataDownload($thang, $prive, $kotakabid);
