...
class FormTeknis1D extends CI_Controller {
	...
	public function SimpanData()
	{
		...
		redirect('/FormTeknis1D/TambahData', 'refresh');
	...
	public function SimpanDataEdit()
	{
		...
		redirect("/FormTeknis1D/editData/$id1B", 'refresh');
	...
	public function downloadExcel()
	{
		...
		$cek = $this->M_dinamis->getById('p_f1D', ['kotakabid' => $kab]);
	...
	public function prosesUploadExcel()
	{
		...
		if (!empty($_FILES['fileExcel']['name'])) {
			...
			if (!$this->upload->do_upload('fileExcel')){
				...
				$this->M_dinamis->delete('p_f1d', ['kotakabid' => $kotakabidX]);
