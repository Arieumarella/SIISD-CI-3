...
class Form7 extends CI_Controller {
	...
	public function editData($id=null)
	{
		...
		$this->load->view('Form7/formEdit1F', $tmp);
	}
	...
	public function SimpanDataEdit()
	{
		...
		$pros = $this->M_dinamis->update('p_f7', $dataInsert, ['id' => $id1B]);
		...
		redirect("/Form7/editData/$id1B", 'refresh');
	...
	public function formExcel()
	{
		...
		$this->load->view('Form7/excelF1', $tmp);
	}
