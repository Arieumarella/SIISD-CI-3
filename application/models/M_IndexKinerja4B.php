...
class M_IndexKinerja4B extends CI_Model {
	...
	{	
		...
		$qry = "SELECT a.nama, a.irigasiid as irigasiidX, b.* FROM m_irigasi AS a LEFT JOIN (SELECT * FROM p_f4b WHERE ta='$thang') AS b on a.irigasiid=b.irigasiid WHERE a.irigasiid='$id'";
