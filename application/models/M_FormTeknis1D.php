...
class M_formTeknis1D extends CI_Model {
	...
	public function getDataTable($jumlahDataPerHalaman, $search, $offset, $provid, $kotakabid)
	{
		...
		$qry2 = "SELECT count(*) as jml_data FROM p_f1d AS a
		LEFT JOIN m_irigasi AS b ON a.irigasiid=b.irigasiid
		WHERE 1=1 $cari";
	...
	{
		$qry = "SELECT b.nama, a.* FROM p_f1d AS a LEFT JOIN m_irigasi AS b on a.irigasiid=b.irigasiid WHERE a.id='$id'";
