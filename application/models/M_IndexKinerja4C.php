...
class M_IndexKinerja4C extends CI_Model {
	...
	public function getDataTable($jumlahDataPerHalaman, $search, $offset, $provid, $kotakabid)
	{
		...
		$qry = "SELECT d.provinsi, c.kemendagri, a.nama, a.irigasiid as irigasiidX, b.id,b.ta,b.provid,b.kotakabid,b.irigasiid,b.laPermen,b.sawahFungsional,b.buSumurA,b.buSumurB,b.buPompaA,b.buPompaB,b.buRumahPompaA,b.buRumahPompaB,b.buRumahA,b.buRumahB,IF(S01_B>0,S01_B,b.saluranPrimerB) AS saluranPrimerB,IF(S01_RR>0,S01_RR,b.saluranPrimerBR) AS saluranPrimerBR,IF(S01_RS>0,S01_RS,b.saluranPrimerRS) AS saluranPrimerRS,IF(S01_RB>0,S01_RB,b.saluranPrimerRB) AS saluranPrimerRB,b.saluranPrimerRerata,b.saluranPrimerNilai,IF(S02_B>0,S02_B,b.saluranSekunderB) AS saluranSekunderB,IF(S02_RR>0,S02_RR,b.saluranSekunderBR) AS saluranSekunderBR,IF(S02_RS>0,S02_RS,b.saluranSekunderRS) AS saluranSekunderRS,IF(S02_RB>0,S02_RB,b.saluranSekunderRB) AS saluranSekunderRB,b.saluranSekunderRerata,b.saluranSekunderNilai,IF(S15_B>0,S15_B,b.saluranTersierB) AS saluranTersierB,IF(S15_RR>0,S15_RR,b.saluranTersierBR) AS saluranTersierBR,IF(S15_RS>0,S15_RS,b.saluranTersierRS) AS saluranTersierRS,IF(S15_RB>0,S15_RB,b.saluranTersierRB) AS saluranTersierRB,b.saluranTersierRerata,b.saluranTersierNilai,IF(S11_B>0,S11_B,b.saluranPembuangB) AS saluranPembuangB,IF(S11_RR>0,S11_RR,b.saluranPembuangBR) AS saluranPembuangBR,IF(S11_RS>0,S11_RS,b.saluranPembuangRS) AS saluranPembuangRS,IF(S11_RB>0,S11_RB,b.saluranPembuangRB) AS saluranPembuangRB,b.saluranPembuangRerata,b.saluranPembuangNilai,b.bppBagiA,IF(P01>0,P01,b.bppBagiB) AS bppBagiB,b.bppBagiSadapA,IF(P02>0,P02,b.bppBagiSadapB) AS bppBagiSadapB,b.bppSadapA,IF(P03>0,P03,b.bppSadapB) AS bppSadapB,b.bppBangunanPengukurA,b.bppBangunanPengukurB,b.bPembawaGorongA,IF(C03>0,C03,b.bPembawaGorongB) AS bPembawaGorongB,b.bPembawaSiponA,IF(C02>0,C02,b.bPembawaSiponB) AS bPembawaSiponB,b.bPembawaTalangA,IF(C04>0,C04,b.bPembawaTalangB) AS bPembawaTalangB,b.bPembawaTerjunanA,IF(C07>0,C07,b.bPembawaTerjunanB) AS bPembawaTerjunanB,b.bPembawaGotMiringA,IF(C11>0,C11,b.bPembawaGotMiringB) AS bPembawaGotMiringB,b.blinPelimpahA,b.blinPelimpahB,b.blinSaluranGendongA,IF(S12>0,S12,b.blinSaluranGendongB) AS blinSaluranGendongB,b.blinPelepasTekanA,b.blinPelepasTekanB,b.blinBakKontrolA,b.blinBakKontrolB,b.blinPerkuatanTebingA,b.blinPerkuatanTebingB,b.balengTampungA,b.balengTampungB,b.balengJalanInspeksiA,IF(S21>0,S21,b.balengJalanInspeksiB) AS balengJalanInspeksiB,b.balengJembatanA,IF(C06>0,C06,b.balengJembatanB) AS balengJembatanB,b.balengKantorPengamatA,b.balengKantorPengamatB,b.balengGudangA,IF(F03>0,F03,b.balengGudangB) AS balengGudangB,b.balengRumahJagaA,b.balengRumahJagaB,b.balengSanggarTaniA,b.balengSanggarTaniB,b.saranaPintuAirA,b.saranaPintuAirB,b.saranaControlValveA,b.saranaControlValveB,b.saranaAlatUkurA,b.saranaAlatUkurB,b.rataJaringanA,b.rataJaringanB,b.keterangan,b.uidIn,b.uidDt,b.uidInUp,b.uidDtUp,b.aksi,
		...
		IF(C03>0,'epaksi','siisd') AS bPembawaGorongBx,
		IF(C02>0,'epaksi','siisd') AS bPembawaSiponBx,
		...
		pjg_S01_B AS pjg_saluranPrimerB,pjg_S01_RR AS pjg_saluranPrimerBR,pjg_S01_RR AS pjg_saluranPrimerRS,pjg_S01_RR AS pjg_saluranPrimerRB,pjg_S02_RR AS pjg_saluranSekunderB,pjg_S02_RR AS pjg_saluranSekunderBR,pjg_S02_RR AS pjg_saluranSekunderRS,pjg_S02_RR AS pjg_saluranSekunderRB,pjg_S15_RR AS pjg_saluranTersierB,pjg_S15_RR AS pjg_saluranTersierBR,pjg_S15_RR AS pjg_saluranTersierRS,pjg_S15_RR AS pjg_saluranTersierRB,pjg_S11_RR AS pjg_saluranPembuangB,pjg_S11_RR AS pjg_saluranPembuangBR,pjg_S11_RR AS pjg_saluranPembuangRS,pjg_S11_RR AS pjg_saluranPembuangRB, a.lper FROM 
		(SELECT * FROM m_irigasi WHERE isActive = '1' AND kategori='DIAT' $cari order by irigasiid LIMIT $jumlahDataPerHalaman OFFSET $offset) AS a
		LEFT JOIN (SELECT * FROM p_f4c WHERE ta='$ta' $cari order by irigasiid) AS b ON a.irigasiid=b.irigasiid
		LEFT JOIN m_prov as d on a.provid=d.provid
		LEFT JOIN m_kotakab as c on a.kotakabid=c.kotakabid
		LEFT JOIN
		(SELECT kode_di,m.* FROM (SELECT k_di,SUM(IF(k_aset='S01' AND kondisi_iksi='BAIK SEKALI',nilai_iksi,0))/SUM(IF(k_aset='S01' AND kondisi_iksi='BAIK SEKALI',1,0)) AS S01_B,SUM(IF(k_aset='S01' AND kondisi_iksi='BAIK',nilai_iksi,0))/SUM(IF(k_aset='S01' AND kondisi_iksi='BAIK',1,0)) AS S01_RR,SUM(IF(k_aset='S01' AND kondisi_iksi='SEDANG',nilai_iksi,0))/SUM(IF(k_aset='S01' AND kondisi_iksi='SEDANG',1,0)) AS S01_RS,SUM(IF(k_aset='S01' AND kondisi_iksi='JELEK',nilai_iksi,0))/SUM(IF(k_aset='S01' AND kondisi_iksi='JELEK',1,0)) AS S01_RB,SUM(IF(k_aset='S02' AND kondisi_iksi='BAIK SEKALI',nilai_iksi,0))/SUM(IF(k_aset='S02' AND kondisi_iksi='BAIK SEKALI',1,0)) AS S02_B,SUM(IF(k_aset='S02' AND kondisi_iksi='BAIK',nilai_iksi,0))/SUM(IF(k_aset='S02' AND kondisi_iksi='BAIK',1,0)) AS S02_RR,SUM(IF(k_aset='S02' AND kondisi_iksi='SEDANG',nilai_iksi,0))/SUM(IF(k_aset='S02' AND kondisi_iksi='SEDANG',1,0)) AS S02_RS,SUM(IF(k_aset='S02' AND kondisi_iksi='JELEK',nilai_iksi,0))/SUM(IF(k_aset='S02' AND kondisi_iksi='JELEK',1,0)) AS S02_RB,SUM(IF(k_aset='S15' AND kondisi_iksi='BAIK SEKALI',nilai_iksi,0))/SUM(IF(k_aset='S15' AND kondisi_iksi='BAIK SEKALI',1,0)) AS S15_B,SUM(IF(k_aset='S15' AND kondisi_iksi='BAIK',nilai_iksi,0))/SUM(IF(k_aset='S15' AND kondisi_iksi='BAIK',1,0)) AS S15_RR,SUM(IF(k_aset='S15' AND kondisi_iksi='SEDANG',nilai_iksi,0))/SUM(IF(k_aset='S15' AND kondisi_iksi='SEDANG',1,0)) AS S15_RS,SUM(IF(k_aset='S15' AND kondisi_iksi='JELEK',nilai_iksi,0))/SUM(IF(k_aset='S15' AND kondisi_iksi='JELEK',1,0)) AS S15_RB,SUM(IF(k_aset='S11' AND kondisi_iksi='BAIK SEKALI',nilai_iksi,0))/SUM(IF(k_aset='S11' AND kondisi_iksi='BAIK SEKALI',1,0)) AS S11_B,SUM(IF(k_aset='S11' AND kondisi_iksi='BAIK',nilai_iksi,0))/SUM(IF(k_aset='S11' AND kondisi_iksi='BAIK',1,0)) AS S11_RR,SUM(IF(k_aset='S11' AND kondisi_iksi='SEDANG',nilai_iksi,0))/SUM(IF(k_aset='S11' AND kondisi_iksi='SEDANG',1,0)) AS S11_RS,SUM(IF(k_aset='S11' AND kondisi_iksi='JELEK',nilai_iksi,0))/SUM(IF(k_aset='S11' AND kondisi_iksi='JELEK',1,0)) AS S11_RB,SUM(IF(k_aset='P01',nilai_iksi,0)) AS P01,SUM(IF(k_aset='P02',nilai_iksi,0)) AS P02,SUM(IF(k_aset='P03',nilai_iksi,0)) AS P03,SUM(IF(k_aset='C03',nilai_iksi,0)) AS C03,SUM(IF(k_aset='C02',nilai_iksi,0)) AS C02,SUM(IF(k_aset='C04',nilai_iksi,0)) AS C04,SUM(IF(k_aset='C07',nilai_iksi,0)) AS C07,SUM(IF(k_aset='C11',nilai_iksi,0)) AS C11,SUM(IF(k_aset='S12',nilai_iksi,0)) AS S12,SUM(IF(k_aset='S21',nilai_iksi,0)) AS S21,SUM(IF(k_aset='C06',nilai_iksi,0)) AS C06,SUM(IF(k_aset='F03',nilai_iksi,0)) AS F03,SUM(IF(k_aset='S01' AND kondisi_iksi='BAIK SEKALI',panjang,0)) AS pjg_S01_B,SUM(IF(k_aset='S01' AND kondisi_iksi='BAIK',panjang,0)) AS pjg_S01_RR,SUM(IF(k_aset='S01' AND kondisi_iksi='SEDANG',panjang,0)) AS pjg_S01_RS,SUM(IF(k_aset='S01' AND kondisi_iksi='JELEK',panjang,0)) AS pjg_S01_RB,SUM(IF(k_aset='S02' AND kondisi_iksi='BAIK SEKALI',panjang,0)) AS pjg_S02_B,SUM(IF(k_aset='S02' AND kondisi_iksi='BAIK',panjang,0)) AS pjg_S02_RR,SUM(IF(k_aset='S02' AND kondisi_iksi='SEDANG',panjang,0)) AS pjg_S02_RS,SUM(IF(k_aset='S02' AND kondisi_iksi='JELEK',panjang,0)) AS pjg_S02_RB,SUM(IF(k_aset='S15' AND kondisi_iksi='BAIK SEKALI',panjang,0)) AS pjg_S15_B,SUM(IF(k_aset='S15' AND kondisi_iksi='BAIK',panjang,0)) AS pjg_S15_RR,SUM(IF(k_aset='S15' AND kondisi_iksi='SEDANG',panjang,0)) AS pjg_S15_RS,SUM(IF(k_aset='S15' AND kondisi_iksi='JELEK',panjang,0)) AS pjg_S15_RB,SUM(IF(k_aset='S11' AND kondisi_iksi='BAIK SEKALI',panjang,0)) AS pjg_S11_B,SUM(IF(k_aset='S11' AND kondisi_iksi='BAIK',panjang,0)) AS pjg_S11_RR,SUM(IF(k_aset='S11' AND kondisi_iksi='SEDANG',panjang,0)) AS pjg_S11_RS,SUM(IF(k_aset='S11' AND kondisi_iksi='JELEK',panjang,0)) AS pjg_S11_RB
			FROM `epaksi_f4` WHERE 1=1  $cariTabelEpaksi GROUP BY k_di) AS m 
		LEFT JOIN (SELECT DISTINCT k_propinsi,k_kabupaten,k_di,n_di,kode_di from m_mapping_di WHERE 1=1 $cariTabelEpaksi order by k_di) as n on m.k_di=n.k_di order by kode_di) as e on b.irigasiid=e.kode_di
		WHERE 1=1 ORDER BY d.provinsi, c.kemendagri";


		$qry2 = "SELECT count(*) as jml_data FROM (SELECT * FROM m_irigasi WHERE isActive = '1' AND kategori='DIAT' $cari) AS a
		";
	...
	public function getDataDi($searchDIR, $kdprov, $kdKab)
	{
		...
		$qry = "SELECT irigasiid as id, CONCAT(nama, ' ', '(', lper, ' Ha)', ' - ', kemendagri)  as text from m_irigasi  LEFT JOIN m_kotakab on m_irigasi.kotakabid=m_kotakab.kotakabid WHERE 1=1 AND kategori='DIAT' $searchDIR LIMIT 80 ";
	...
	public function getDataDiById($id='')
	{
		...
		$qry = "SELECT a.nama, a.irigasiid as irigasiidX, b.*, a.lper FROM (SELECT * FROM m_irigasi WHERE isActive = '1') AS a LEFT JOIN (SELECT * FROM p_f4c WHERE ta='$thang') AS b on a.irigasiid=b.irigasiid WHERE a.irigasiid='$id'";
	...
	public function getDataDiFull($thangX, $kab)
	{
		...
		(SELECT * FROM m_irigasi WHERE isActive = '1' AND kategori='DIAT' $cari order by irigasiid) AS a
		LEFT JOIN (SELECT * FROM p_f4c WHERE ta='$ta' $cari order by irigasiid) AS b ON a.irigasiid=b.irigasiid
		LEFT JOIN m_prov as d on a.provid=d.provid
		LEFT JOIN m_kotakab as c on a.kotakabid=c.kotakabid
		LEFT JOIN
