...
class M_formTeknis1C extends CI_Model {
	...
	{
		$qry = "SELECT b.nama, a.* FROM p_f1c AS a LEFT JOIN m_irigasi AS b on a.irigasiid=b.irigasiid WHERE a.id='$id'";
